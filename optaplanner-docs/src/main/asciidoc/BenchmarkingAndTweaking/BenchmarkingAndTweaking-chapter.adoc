...
To do that, set up a benchmark configuration:
...
The benchmark report will be written in the directory specified by the `<benchmarkDirectory>` element (relative to the working directory).
