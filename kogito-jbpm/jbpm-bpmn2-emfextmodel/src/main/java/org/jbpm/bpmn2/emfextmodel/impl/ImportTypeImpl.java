 ...
 * <ul>
 *   <li>{@link org.jbpm.bpmn2.emfextmodel.impl.ImportTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportTypeImpl extends EObjectImpl implements ImportType {
    ...
    protected EClass eStaticClass() {
        return EmfextmodelPackage.Literals.IMPORT_TYPE;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EmfextmodelPackage.IMPORT_TYPE__NAME, oldName, name));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case EmfextmodelPackage.IMPORT_TYPE__NAME:
                return getName();
        }
