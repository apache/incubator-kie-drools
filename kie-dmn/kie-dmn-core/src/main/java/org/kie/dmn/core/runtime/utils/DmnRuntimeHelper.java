 ...
 * under the License.
 */
package org.kie.dmn.core.runtime.utils;

import org.kie.dmn.api.core.DMNResult;
import org.kie.dmn.core.runtime.model.EfestoOutputDMN;
import org.kie.dmn.core.runtime.service.DMNEvaluator;
...
public class DmnRuntimeHelper {
    ...
    public static boolean canManage(EfestoInput toEvaluate, EfestoRuntimeContext context) {
        return GeneratedResourceUtils.isPresentModel(toEvaluate.getModelLocalUriId(), context);
    }

    public static Optional<EfestoOutputDMN> execute(EfestoInput<Map<String, Object>> toEvaluate, EfestoRuntimeContext runtimeContext) {
        ModelLocalUriId modelLocalUriId = toEvaluate.getModelLocalUriId();
        Optional<GeneratedModelResource> generatedModelResource = GeneratedResourceUtils.getGeneratedModelResource(modelLocalUriId, runtimeContext.getGeneratedResourcesMap());
