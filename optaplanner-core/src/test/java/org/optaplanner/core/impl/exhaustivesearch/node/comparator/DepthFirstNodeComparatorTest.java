...
public class DepthFirstNodeComparatorTest {
    ...
    public ExhaustiveSearchNode buildNode(int depth, int optimisticBoundString, long indexInLayer) {
    ...
    public static void assertLesser(Comparator<ExhaustiveSearchNode> comparator,
    ...
    public static void assertScoreCompareToOrder(Comparator<ExhaustiveSearchNode> comparator,
