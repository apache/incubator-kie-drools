...
final class TriConstraintIntConsequence<A, B, C>
        extends AbstractTriConstraintConsequence<A, B, C>
        implements Supplier<ToIntTriFunction<A, B, C>> {

    private final TriLeftHandSide<A, B, C> leftHandSide;
    private final ToIntTriFunction<A, B, C> matchWeighter;

    TriConstraintIntConsequence(TriLeftHandSide<A, B, C> leftHandSide, ToIntTriFunction<A, B, C> matchWeighter) {
