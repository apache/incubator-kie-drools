...
class AppendFunctionTest {
    ...
    void invokeInvalidParams() {
        ...
        FunctionTestUtil.assertResultError(appendFunction.invoke((List) null, new Object[]{}),
                                           InvalidParametersEvent.class);
        FunctionTestUtil.assertResultError(appendFunction.invoke(Collections.emptyList(), null),
                                           InvalidParametersEvent.class);
    }
    ...
    void invokeAppendNothing() {
        ...
        FunctionTestUtil.assertResultList(appendFunction.invoke(Arrays.asList("test", "test2"), new Object[]{}),
