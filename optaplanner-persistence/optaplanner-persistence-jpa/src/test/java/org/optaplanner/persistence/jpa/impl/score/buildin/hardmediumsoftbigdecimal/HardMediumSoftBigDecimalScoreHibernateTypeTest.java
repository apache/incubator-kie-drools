...
public class HardMediumSoftBigDecimalScoreHibernateTypeTest extends AbstractScoreHibernateTypeTest {
    ...
    public void persistAndMerge() {
        persistAndMerge(new TestJpaEntity(null),
                HardMediumSoftBigDecimalScore.valueOfInitialized(new BigDecimal("-10.01000"), new BigDecimal("-4.32100"), new BigDecimal("-2.20000")),
                HardMediumSoftBigDecimalScore.valueOf(-7, new BigDecimal("-10.01000"), new BigDecimal("-4.32100"), new BigDecimal("-2.20000")));
    }
