...
public class KieFEELExtendedFunctionsTest extends BaseFEELTest {
    ...
    public static Collection<Object[]> data() {
        final Object[][] cases = new Object[][] {
                ...
                { "started by( date(\"2018-08-15\"), date(\"2018-08-15\") )", Boolean.FALSE, null },
                { "started by( date(\"2018-07-25\"), [date(\"2018-07-25\")..date(\"2018-08-10\")] )", Boolean.FALSE, null },
                ...
                { "finished by( date(\"2018-08-15\"), date(\"2018-08-15\") )", Boolean.FALSE, null },
                { "finished by( date(\"2018-08-10\"), [date(\"2018-07-25\")..date(\"2018-08-10\")] )", Boolean.FALSE, null },
                ...
                { "during( date(\"2018-08-15\"), date(\"2018-08-15\") )", Boolean.FALSE, null },
                { "during( date(\"2018-07-29\"), [date(\"2018-07-25\")..date(\"2018-08-10\")] )", Boolean.TRUE, null },
                { "during( [date(\"2018-08-15\")..date(\"2018-08-31\")], date(\"2018-08-25\") )", Boolean.FALSE, null },
                { "during( [date(\"2018-08-17\")..date(\"2018-08-20\")], [date(\"2018-08-15\")..date(\"2018-08-31\")] )", Boolean.TRUE, null },
                { "includes( date(\"2018-08-15\"), date(\"2018-08-15\") )", Boolean.FALSE, null },
