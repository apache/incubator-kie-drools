...
public class PackageKjarDependenciesExecutor {

    private static final Pattern ALT_REPO_SYNTAX_PATTERN = Pattern.compile("(.+)::(.*)::(.+)");

    private PackageKjarDependenciesExecutor() {
    }

    public static void packageKJarDependencies(final MavenSession mavenSession,
                                               final File outputDirectory,
                                               final List<ArtifactRepository> pomRemoteRepositories,
                                               final List<ArtifactItem> artifactItems,
                                               final ArtifactResolver artifactResolver,
                                               final ArtifactHandlerManager artifactHandlerManager,
                                               final DependencyResolver dependencyResolver,
                                               final ProjectBuilder projectBuilder,
                                               final RepositorySystem repositorySystem,
                                               final Map<String, ArtifactRepositoryLayout> repositoryLayouts,
