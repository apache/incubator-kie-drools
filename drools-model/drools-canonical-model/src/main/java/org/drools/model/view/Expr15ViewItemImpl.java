...
// Continue defining Expr15ViewItemImpl
public class Expr15ViewItemImpl<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> extends AbstractExprViewItem<A> implements ExprNViewItem<A> {
    ...
    public Expr15ViewItemImpl(Variable<A> var1, Variable<B> var2, Variable<C> var3, Variable<D> var4, Variable<E> var5, Variable<F> var6, Variable<G> var7,
    ...
    public Expr15ViewItemImpl(String exprId, Variable<A> var1, Variable<B> var2, Variable<C> var3, Variable<D> var4, Variable<E> var5, Variable<F> var6,
                              Variable<G> var7, Variable<H> var8, Variable<I> var9, Variable<J> var10, Variable<K> var11, Variable<L> var12, Variable<M> var13, Variable<N> var14, Variable<O> var15,
                              Predicate15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> predicate) {
        super(exprId, var1);
        this.var2 = var2;
        this.var3 = var3;
    ...
    public Predicate15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> getPredicate() {
        return predicate;
    }
    ...
    public Variable<?>[] getVariables() {
        return new Variable[]{getFirstVariable(), getVar2(), getVar3(), getVar4(), getVar5(), getVar6(), getVar7(), getVar8(), getVar9(), getVar10(), getVar11(), getVar12(), getVar13(), getVar14(), getVar15()};
    }
