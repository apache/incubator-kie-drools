 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.PoissonDistributionTypeImpl#getMean <em>Mean</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PoissonDistributionTypeImpl extends DistributionParameterImpl implements PoissonDistributionType {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.POISSON_DISTRIBUTION_TYPE;
	}
	...
	public void setMean(double newMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.POISSON_DISTRIBUTION_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.POISSON_DISTRIBUTION_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.POISSON_DISTRIBUTION_TYPE__MEAN:
				return getMean();
		}
