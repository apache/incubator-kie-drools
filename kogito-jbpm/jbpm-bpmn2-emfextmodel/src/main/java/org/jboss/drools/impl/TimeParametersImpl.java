 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.TimeParametersImpl#getTransferTime <em>Transfer Time</em>}</li>
 *   <li>{@link org.jboss.drools.impl.TimeParametersImpl#getQueueTime <em>Queue Time</em>}</li>
 *   <li>{@link org.jboss.drools.impl.TimeParametersImpl#getWaitTime <em>Wait Time</em>}</li>
 *   <li>{@link org.jboss.drools.impl.TimeParametersImpl#getSetUpTime <em>Set Up Time</em>}</li>
...
public class TimeParametersImpl extends EObjectImpl implements TimeParameters {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.TIME_PARAMETERS;
	}
	...
	public NotificationChain basicSetTransferTime(Parameter newTransferTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__TRANSFER_TIME, oldTransferTime, newTransferTime);
	...
	public void setTransferTime(Parameter newTransferTime) {
		if (newTransferTime != transferTime) {
			...
			if (transferTime != null)
				msgs = ((InternalEObject)transferTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__TRANSFER_TIME, null, msgs);
			if (newTransferTime != null)
				msgs = ((InternalEObject)newTransferTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__TRANSFER_TIME, null, msgs);
			msgs = basicSetTransferTime(newTransferTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__TRANSFER_TIME, newTransferTime, newTransferTime));
	}
	...
	public NotificationChain basicSetQueueTime(Parameter newQueueTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__QUEUE_TIME, oldQueueTime, newQueueTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setQueueTime(Parameter newQueueTime) {
		if (newQueueTime != queueTime) {
			NotificationChain msgs = null;
			if (queueTime != null)
				msgs = ((InternalEObject)queueTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__QUEUE_TIME, null, msgs);
			if (newQueueTime != null)
				msgs = ((InternalEObject)newQueueTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__QUEUE_TIME, null, msgs);
			msgs = basicSetQueueTime(newQueueTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__QUEUE_TIME, newQueueTime, newQueueTime));
	}
	...
	public NotificationChain basicSetWaitTime(Parameter newWaitTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__WAIT_TIME, oldWaitTime, newWaitTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWaitTime(Parameter newWaitTime) {
		if (newWaitTime != waitTime) {
			NotificationChain msgs = null;
			if (waitTime != null)
				msgs = ((InternalEObject)waitTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__WAIT_TIME, null, msgs);
			if (newWaitTime != null)
				msgs = ((InternalEObject)newWaitTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__WAIT_TIME, null, msgs);
			msgs = basicSetWaitTime(newWaitTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__WAIT_TIME, newWaitTime, newWaitTime));
	}
	...
	public NotificationChain basicSetSetUpTime(Parameter newSetUpTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__SET_UP_TIME, oldSetUpTime, newSetUpTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSetUpTime(Parameter newSetUpTime) {
		if (newSetUpTime != setUpTime) {
			NotificationChain msgs = null;
			if (setUpTime != null)
				msgs = ((InternalEObject)setUpTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__SET_UP_TIME, null, msgs);
			if (newSetUpTime != null)
				msgs = ((InternalEObject)newSetUpTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__SET_UP_TIME, null, msgs);
			msgs = basicSetSetUpTime(newSetUpTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__SET_UP_TIME, newSetUpTime, newSetUpTime));
	}
	...
	public NotificationChain basicSetProcessingTime(Parameter newProcessingTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__PROCESSING_TIME, oldProcessingTime, newProcessingTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProcessingTime(Parameter newProcessingTime) {
		if (newProcessingTime != processingTime) {
			...
			if (processingTime != null)
				msgs = ((InternalEObject)processingTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__PROCESSING_TIME, null, msgs);
			if (newProcessingTime != null)
				msgs = ((InternalEObject)newProcessingTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__PROCESSING_TIME, null, msgs);
			msgs = basicSetProcessingTime(newProcessingTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__PROCESSING_TIME, newProcessingTime, newProcessingTime));
	}
	...
	public NotificationChain basicSetValidationTime(Parameter newValidationTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__VALIDATION_TIME, oldValidationTime, newValidationTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValidationTime(Parameter newValidationTime) {
		if (newValidationTime != validationTime) {
			...
			if (validationTime != null)
				msgs = ((InternalEObject)validationTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__VALIDATION_TIME, null, msgs);
			if (newValidationTime != null)
				msgs = ((InternalEObject)newValidationTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__VALIDATION_TIME, null, msgs);
			msgs = basicSetValidationTime(newValidationTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__VALIDATION_TIME, newValidationTime, newValidationTime));
	}
	...
	public NotificationChain basicSetReworkTime(Parameter newReworkTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__REWORK_TIME, oldReworkTime, newReworkTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReworkTime(Parameter newReworkTime) {
		if (newReworkTime != reworkTime) {
			NotificationChain msgs = null;
			if (reworkTime != null)
				msgs = ((InternalEObject)reworkTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__REWORK_TIME, null, msgs);
			if (newReworkTime != null)
				msgs = ((InternalEObject)newReworkTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.TIME_PARAMETERS__REWORK_TIME, null, msgs);
			msgs = basicSetReworkTime(newReworkTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TIME_PARAMETERS__REWORK_TIME, newReworkTime, newReworkTime));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DroolsPackage.TIME_PARAMETERS__TRANSFER_TIME:
				return basicSetTransferTime(null, msgs);
			case DroolsPackage.TIME_PARAMETERS__QUEUE_TIME:
				return basicSetQueueTime(null, msgs);
			case DroolsPackage.TIME_PARAMETERS__WAIT_TIME:
				return basicSetWaitTime(null, msgs);
			case DroolsPackage.TIME_PARAMETERS__SET_UP_TIME:
				return basicSetSetUpTime(null, msgs);
			case DroolsPackage.TIME_PARAMETERS__PROCESSING_TIME:
				return basicSetProcessingTime(null, msgs);
			case DroolsPackage.TIME_PARAMETERS__VALIDATION_TIME:
