 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.NormalDistributionTypeImpl#getMean <em>Mean</em>}</li>
 *   <li>{@link org.jboss.drools.impl.NormalDistributionTypeImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NormalDistributionTypeImpl extends DistributionParameterImpl implements NormalDistributionType {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.NORMAL_DISTRIBUTION_TYPE;
	}
	...
	public void setMean(double newMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.NORMAL_DISTRIBUTION_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.NORMAL_DISTRIBUTION_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
	...
	public void setStandardDeviation(double newStandardDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION, oldStandardDeviation, standardDeviation, !oldStandardDeviationESet));
	}
	...
	public void unsetStandardDeviation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION, oldStandardDeviation, STANDARD_DEVIATION_EDEFAULT, oldStandardDeviationESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.NORMAL_DISTRIBUTION_TYPE__MEAN:
				return getMean();
			case DroolsPackage.NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION:
