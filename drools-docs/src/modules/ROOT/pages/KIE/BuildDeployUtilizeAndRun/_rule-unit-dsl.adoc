...
However, {PRODUCT} 8 offers an alternative way of writing Rule Unit rules. Now you can write rules with Java APIs. Let's learn with comments on the example.
