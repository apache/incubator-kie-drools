 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.StringParameterTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringParameterTypeImpl extends ConstantParameterImpl implements StringParameterType {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.STRING_PARAMETER_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.STRING_PARAMETER_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.STRING_PARAMETER_TYPE__VALUE:
				return getValue();
		}
