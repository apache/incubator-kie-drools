...
public class KiePMMLDroolsRule {
    ...
    public static class Builder {
        ...
        /**
         * @param constraints The <b>key</b> of the map is the name of the generated type, while the <b>value</b> is
         * the <code>List&lt;KiePMMLOperatorValue&gt;</code>
         *                    to use for evaluation. Implicitly, the latter is evaluated with the <b>value</b> field
         *                    of the former
         *                    (e.g entry <b>"OUTLOOK"/List(KiePMMLOperatorValue("==", "sunny"))</b> generates
         *
         *                    <p><code>OUTLOOK(value == "sunny")</code></p>)
         *                    <p>
         *                    (e.g entry <b>"TEMPERATURE"/List(KiePMMLOperatorValue("<", 90), KiePMMLOperatorValue
         *                    (">", 50))</b> generates
         *
         ...
         *                    to use for evaluation. Implicitly, the "operator" and the "value" fields are evaluated
         *                    with the <b>value</b> field of the former
         *                    (e.g entry <b>KiePMMLOperatorValue("OUTLOOK", "==", "sunny"))</b> generates
         *
         *                    <p><code>OUTLOOK(value == "sunny")</code></p>)
         *                    <p>
         *                    (e.g entry <b>KiePMMLOperatorValue("TEMPERATURE", "<", 90), KiePMMLOperatorValue
         *                    ("TEMPERATURE",">", 50))</b> generates
         *
