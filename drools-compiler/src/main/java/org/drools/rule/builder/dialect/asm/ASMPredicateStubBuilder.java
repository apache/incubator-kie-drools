    ...
    private void createStubPredicate(final ClassGenerator generator, final InvokerDataProvider data, final Map vars) {
        ...
        generator.addMethod(ACC_PUBLIC, "createContext", generator.methodDescr(Object.class), new ClassGenerator.MethodBody() {
            ...
            public void body(MethodVisitor mv) {
                ...
                invokeStatic(PredicateGenerator.class, "generate", null, PredicateStub.class, Object.class, Tuple.class, Declaration[].class, Declaration[].class, WorkingMemory.class, Object.class);
                mv.visitLabel(l1);
                mv.visitVarInsn(ALOAD, 0);
                getField("predicate", PredicateExpression.class);
                mv.visitVarInsn(ALOAD, 1);
