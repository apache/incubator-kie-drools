...
--
. On the *Data Types* page, click *Add* to add a new data type or click *Import Data Object* to import an existing data object from your project that you want to use as a DMN data type.
+
--
...
For this example, click *Add* and create a *Credit_Score_Rating* data type as a `string`:
