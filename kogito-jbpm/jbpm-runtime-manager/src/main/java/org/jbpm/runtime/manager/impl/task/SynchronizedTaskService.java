...
public class SynchronizedTaskService implements TaskServiceEntryPoint {
	...
	public SynchronizedTaskService(KieSession ksession, TaskServiceEntryPoint taskService) {
