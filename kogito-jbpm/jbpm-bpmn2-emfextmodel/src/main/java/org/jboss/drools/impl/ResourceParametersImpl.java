...
public class ResourceParametersImpl extends EObjectImpl implements ResourceParameters {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.RESOURCE_PARAMETERS;
	}
	...
	public NotificationChain basicSetSelection(Parameter newSelection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.RESOURCE_PARAMETERS__SELECTION, oldSelection, newSelection);
	...
	public void setSelection(Parameter newSelection) {
		if (newSelection != selection) {
			...
			if (selection != null)
				msgs = ((InternalEObject)selection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.RESOURCE_PARAMETERS__SELECTION, null, msgs);
			if (newSelection != null)
				msgs = ((InternalEObject)newSelection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.RESOURCE_PARAMETERS__SELECTION, null, msgs);
			msgs = basicSetSelection(newSelection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.RESOURCE_PARAMETERS__SELECTION, newSelection, newSelection));
	}
	...
	public NotificationChain basicSetAvailability(Parameter newAvailability, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.RESOURCE_PARAMETERS__AVAILABILITY, oldAvailability, newAvailability);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAvailability(Parameter newAvailability) {
		if (newAvailability != availability) {
			...
			if (availability != null)
				msgs = ((InternalEObject)availability).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.RESOURCE_PARAMETERS__AVAILABILITY, null, msgs);
			if (newAvailability != null)
				msgs = ((InternalEObject)newAvailability).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.RESOURCE_PARAMETERS__AVAILABILITY, null, msgs);
			msgs = basicSetAvailability(newAvailability, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.RESOURCE_PARAMETERS__AVAILABILITY, newAvailability, newAvailability));
	}
	...
	public NotificationChain basicSetQuantity(Parameter newQuantity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.RESOURCE_PARAMETERS__QUANTITY, oldQuantity, newQuantity);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setQuantity(Parameter newQuantity) {
		if (newQuantity != quantity) {
			NotificationChain msgs = null;
			if (quantity != null)
				msgs = ((InternalEObject)quantity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.RESOURCE_PARAMETERS__QUANTITY, null, msgs);
			if (newQuantity != null)
				msgs = ((InternalEObject)newQuantity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.RESOURCE_PARAMETERS__QUANTITY, null, msgs);
			msgs = basicSetQuantity(newQuantity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.RESOURCE_PARAMETERS__QUANTITY, newQuantity, newQuantity));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DroolsPackage.RESOURCE_PARAMETERS__SELECTION:
				return basicSetSelection(null, msgs);
			case DroolsPackage.RESOURCE_PARAMETERS__AVAILABILITY:
