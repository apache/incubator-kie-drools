...
public class CDISupportProcessTSInjectionSingletonTest extends SupportProcessBaseTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CDISupportProcessTSInjectionSingletonTest.class);
    ...
    public static void before() {
    	System.setProperty("org.jbpm.cdi.taskservice.mode", "singleton");
    }
    
    @AfterClass
    public static void clear() {
    	System.clearProperty("org.jbpm.cdi.taskservice.mode");
    }
