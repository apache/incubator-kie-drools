...
image::planner-introduction/download-and-run-the-examples/distributionZip.png[align="center"]

The Examples GUI application will open.
Pick an example to try it out:

image::planner-introduction/download-and-run-the-examples/plannerExamplesAppScreenshot.png[align="center"]
