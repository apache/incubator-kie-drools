...
public class MockKieRuntimeServiceC extends AbstractMockKieRuntimeService {
    ...
    private final static ModelLocalUriId modelLocalUriIdC =  new ModelLocalUriId(LocalUri.parse("/"  + MockEfestoInputC.class.getSimpleName() + "/" + MockEfestoInputC.class.getPackage().getName()));
