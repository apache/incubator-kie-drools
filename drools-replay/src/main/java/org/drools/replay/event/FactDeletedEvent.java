...
public class FactDeletedEvent extends ExecutionEvent {
    ...
    public FactDeletedEvent(long sequenceNumber, String factClassName, String factIdentity,
                            String factToString, String triggeringRule) {
        super(sequenceNumber, EventType.FACT_DELETED);
