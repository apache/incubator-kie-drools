...
public class PhreakExistsNode {
    ...
    private static void insertChildLeftTuple( LeftTupleSink sink, LeftTupleSets trgLeftTuples, LeftTuple leftTuple, PropagationContext pctx, boolean useLeftMemory ) {
