...
public class KieMemoryCompiler {
     ...
     *
     * <p><b>Compiler selection:</b> this convenience overload (and the
     * {@link #compileNoLoad(Map, ClassLoader, JavaCompilerSettings)} overload)
     * hardcode {@link JavaConfiguration.CompilerType#NATIVE} and do <i>not</i> honor the
     * {@code drools.dialect.java.compiler} system property. Callers that need to opt
     * into the Eclipse compiler must use the four-argument
     * {@link #compileNoLoad(Map, ClassLoader, JavaCompilerSettings, JavaConfiguration.CompilerType)}
     * overload and pass {@link JavaConfiguration.CompilerType#ECLIPSE} explicitly.
     *
     * <p>This path is used by the Drools Quarkus extension for build-time compilation
     * of generated sources, so <b>Quarkus build-time compilation is Native-only</b>
     * regardless of the {@code drools.dialect.java.compiler} property.
     */
     ...
     * Additional compiler settings can be provided using JavaCompilerSettings.
     *
     * <p>Like {@link #compileNoLoad(Map, ClassLoader)}, this overload hardcodes
     * {@link JavaConfiguration.CompilerType#NATIVE}. See that method for details on
     * compiler selection.
     */
