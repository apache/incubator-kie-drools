 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.BetaDistributionTypeImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link org.jboss.drools.impl.BetaDistributionTypeImpl#getShape <em>Shape</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BetaDistributionTypeImpl extends DistributionParameterImpl implements BetaDistributionType {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.BETA_DISTRIBUTION_TYPE;
	}
	...
	public void setScale(double newScale) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.BETA_DISTRIBUTION_TYPE__SCALE, oldScale, scale, !oldScaleESet));
	}
	...
	public void unsetScale() {
		...
		scaleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.BETA_DISTRIBUTION_TYPE__SCALE, oldScale, SCALE_EDEFAULT, oldScaleESet));
	}
	...
	public void setShape(double newShape) {
		...
		shapeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.BETA_DISTRIBUTION_TYPE__SHAPE, oldShape, shape, !oldShapeESet));
	}
	...
	public void unsetShape() {
		...
		shapeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.BETA_DISTRIBUTION_TYPE__SHAPE, oldShape, SHAPE_EDEFAULT, oldShapeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.BETA_DISTRIBUTION_TYPE__SCALE:
				return getScale();
			case DroolsPackage.BETA_DISTRIBUTION_TYPE__SHAPE:
				return getShape();
		}
