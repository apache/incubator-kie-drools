...
public class LinearRegressionSampleWithTransformationsTest extends AbstractPMMLTest {
    ...
    private static final String OUT_DER_FUN_SALARY_APPLY_FUN_SALARY_FIELDREF = "out_der_fun_salary_apply_fun_salary_fieldref";
    ...
    private static double FUN_SALARY = 9.87654321E8;
    ...
    public void testLogisticRegressionIrisData() {
        ...
        Assertions.assertThat(pmml4Result.getResultVariables().get(OUT_DER_FUN_SALARY_APPLY_FUN_SALARY_FIELDREF)).isEqualTo(FUN_SALARY);
        ...
        Assertions.assertThat(pmml4Result.getResultVariables().get(OUT_DER_FUN_SALARY_FIELDREF)).isEqualTo(FUN_SALARY);
    }
}
