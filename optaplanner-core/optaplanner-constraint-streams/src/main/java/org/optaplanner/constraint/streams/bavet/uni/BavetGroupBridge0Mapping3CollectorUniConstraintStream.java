...
final class BavetGroupBridge0Mapping3CollectorUniConstraintStream<Solution_, A, ResultContainerA_, NewA, ResultContainerB_, NewB, ResultContainerC_, NewC>
    ...
    public BavetGroupBridge0Mapping3CollectorUniConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected AbstractGroupUniNode<A, TriTuple<NewA, NewB, NewC>, ?, ?, ?> createNode(int inputStoreIndex,
        ...
        return new Group0Mapping3CollectorUniNode<>(inputStoreIndex,
