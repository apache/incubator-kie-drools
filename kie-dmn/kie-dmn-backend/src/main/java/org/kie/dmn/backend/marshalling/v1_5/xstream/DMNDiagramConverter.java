...
public class DMNDiagramConverter extends DiagramConverter {
    ...
    protected void assignAttributes(HierarchicalStreamReader reader, Object parent) {
        ...
        DMNDiagram id = (DMNDiagram) parent;
        id.setUseAlternativeInputDataShape(
                Boolean.parseBoolean(reader.getAttribute(USE_ALTERNATIVE_INPUT_DATA_SHAPE)));
    }
    ...
    protected void writeAttributes(HierarchicalStreamWriter writer, Object parent) {
        ...
        if (id.getUseAlternativeInputDataShape() != null) {
            writer.addAttribute(USE_ALTERNATIVE_INPUT_DATA_SHAPE, id.getUseAlternativeInputDataShape().toString());
        }
    }
    ...
    protected DMNModelInstrumentedBase createModelObject() {
        return new org.kie.dmn.model.v1_5.dmndi.DMNDiagram();
    }

    @Override
    public boolean canConvert(Class clazz) {
        return clazz.equals(org.kie.dmn.model.v1_5.dmndi.DMNDiagram.class);
    }
