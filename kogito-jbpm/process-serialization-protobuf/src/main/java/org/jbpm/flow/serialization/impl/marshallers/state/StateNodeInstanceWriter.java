...
public class StateNodeInstanceWriter implements NodeInstanceWriter {
    ...
    public boolean accept(NodeInstance value) {
        return value instanceof StateNodeInstance;
    }

    @Override
    public Builder<?> write(MarshallerWriterContext context, NodeInstance value) {
        StateNodeInstance nodeInstance = (StateNodeInstance) value;
