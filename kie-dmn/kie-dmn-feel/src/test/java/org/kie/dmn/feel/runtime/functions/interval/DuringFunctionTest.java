...
public class DuringFunctionTest {
    ...
    public void invokeParamIsNull() {
        FunctionTestUtil.assertResultError( duringFunction.invoke((Comparable) null, (Comparable) "b" ), InvalidParametersEvent.class );
        FunctionTestUtil.assertResultError( duringFunction.invoke((Comparable) "a", (Comparable) null ), InvalidParametersEvent.class );
    }
    ...
    public void invokeParamSingles() {
        FunctionTestUtil.assertResult( duringFunction.invoke( "a", "b" ), Boolean.FALSE );
        FunctionTestUtil.assertResult( duringFunction.invoke( "a", "a" ), Boolean.FALSE );
        FunctionTestUtil.assertResult( duringFunction.invoke( "b", "a" ), Boolean.FALSE );
        FunctionTestUtil.assertResult( duringFunction.invoke( BigDecimal.valueOf(2), BigDecimal.valueOf(1) ), Boolean.FALSE );
        FunctionTestUtil.assertResult( duringFunction.invoke( BigDecimal.valueOf(1), BigDecimal.valueOf(2) ), Boolean.FALSE );
        FunctionTestUtil.assertResult( duringFunction.invoke( BigDecimal.valueOf(1), BigDecimal.valueOf(1) ), Boolean.FALSE );
    }
