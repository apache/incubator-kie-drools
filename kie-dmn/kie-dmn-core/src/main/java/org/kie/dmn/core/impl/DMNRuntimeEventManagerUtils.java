...
public final class DMNRuntimeEventManagerUtils {
    ...
    public static void fireAfterEvaluateDecisionTable( String DecisionName, DMNRuntimeEventManager eventManager, String nodeName, String dtName, String dtId, DMNResult result, List<Integer> matches, List<Integer> fired, List<String> matchedIds, List<String> firedIds ) {
        if( eventManager.hasListeners() ) {
            ...
            notifyListeners(eventManager, l -> l.afterEvaluateDecisionTable(event, DecisionName));
        }
    }
    ...
    public static void fireAfterConditionalEvaluation(DMNRuntimeEventManager eventManager, String conditionalName, String rootElementName, EvaluatorResult evaluatorResult, String idExecuted) {
        if( eventManager.hasListeners() ) {
            AfterConditionalEvaluationEvent event = new AfterConditionalEvaluationEventImpl(conditionalName, rootElementName, evaluatorResult, idExecuted);
