...
class ScenarioSimulationServerMessagesTest {

    @Test
    void getFactWithWrongValueExceptionMessage_manyCases() {
    ...
    @Test
    void getIndexedScenarioMessage_manyCases() {
