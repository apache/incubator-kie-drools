...
import org.drools.planner.core.heuristic.selector.variable.VariableSelector;
import org.drools.planner.core.move.Move;
import org.drools.planner.core.phase.event.SolverPhaseLifecycleListener;

/**
 * General interface for {@link MoveSelector}, {@link EntitySelector}, {@link VariableSelector}
 * and {@link ValueSelector} which generates {@link Move}s or parts of them.
 */
public interface Selector extends SolverPhaseLifecycleListener {
     ...
     * but nnot if only {@link #isNeverEnding()} returns true
     */
    long getSize();
