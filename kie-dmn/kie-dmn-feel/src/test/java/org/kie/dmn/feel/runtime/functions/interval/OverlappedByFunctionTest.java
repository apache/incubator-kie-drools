...
public class OverlappedByFunctionTest {
    ...
    public void invokeParamIsNull() {
        FunctionTestUtil.assertResultError( overlappedByFunction.invoke((Range) null, (Range) new RangeImpl() ), InvalidParametersEvent.class );
        FunctionTestUtil.assertResultError( overlappedByFunction.invoke((Range) new RangeImpl(), (Range) null ), InvalidParametersEvent.class );
    }
