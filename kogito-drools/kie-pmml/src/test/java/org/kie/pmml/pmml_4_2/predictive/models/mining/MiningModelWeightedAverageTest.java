...
public class MiningModelWeightedAverageTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                { Optional.of(10.0), Optional.of(10.0), Optional.of(10.0), 1156.6666 },
                { Optional.of(200.0), Optional.of(-1.0), Optional.of(2.0), -299 },
                { Optional.of(5.0), Optional.of(2.0), Optional.of(4.0), 772 },
        });
    }

    public MiningModelWeightedAverageTest(Optional<Double> input1, Optional<Double> input2,
