...
class IndexOfFunctionTest {
    ...
    private static final IndexOfFunction indexOfFunction = IndexOfFunction.INSTANCE;
    ...
    void invokeMatchNull() {
        FunctionTestUtil.assertResultList(indexOfFunction.invoke(Collections.emptyList(), null),
                                          Collections.emptyList());
        FunctionTestUtil.assertResultList(indexOfFunction.invoke(Collections.singletonList("test"), null),
                                          Collections.emptyList());
    ...
    void invokeMatchNotNull() {
        FunctionTestUtil.assertResult(indexOfFunction.invoke(Arrays.asList("test", null, 12), "testttt"),
                                      Collections.emptyList());
        FunctionTestUtil.assertResult(
