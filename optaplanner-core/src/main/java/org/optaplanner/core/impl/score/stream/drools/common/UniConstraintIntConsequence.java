...
final class UniConstraintIntConsequence<A>
        extends AbstractUniConstraintConsequence<A>
        implements Supplier<ToIntFunction<A>> {

    private final UniLeftHandSide<A> leftHandSide;
    private final ToIntFunction<A> matchWeighter;

    UniConstraintIntConsequence(UniLeftHandSide<A> leftHandSide, ToIntFunction<A> matchWeighter) {
