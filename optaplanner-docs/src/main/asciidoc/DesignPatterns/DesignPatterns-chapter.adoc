...
Implement the automatic collapse in the <<customVariableListener,custom variable listener>>
...
Implement the automatic delay in the <<customVariableListener,custom variable listener>>
