...
public class MiningModelLoanTest extends AbstractPMMLTest {

    private static final String FILE_NAME = "MiningModelLoan.pmml";
    private static final String MODEL_NAME = "MiningModelLoan";
    ...
    public MiningModelLoanTest(double age,
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {18, 0, 2, 0, 0, 1, 0, 0, 0.8269655282007256, 0.17303447179927475},
                {20, 30000, 0, 100, 0, 1, 0, 0, 0.7437667760400436, 0.25623322395995635},
        });
    }

    @Test
    public void testMiningModelLoan() throws Exception {
