...
image::PlannerIntroduction/distributionZip.png[align="center"]

The Examples GUI application will open.
Pick an example to try it out:

image::PlannerIntroduction/plannerExamplesAppScreenshot.png[align="center"]
...
image::PlannerIntroduction/plannerWebexamplesScreenshot.png[align="center"]
