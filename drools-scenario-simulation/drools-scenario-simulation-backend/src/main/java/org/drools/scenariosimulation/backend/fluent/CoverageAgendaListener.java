...
public class CoverageAgendaListener extends DefaultAgendaEventListener {
    ...
    public static String generateAuditMessage(String ruleName, Integer counter) {
        return "Executed rule: " + ruleName + " (" + counter + ")";
    }
    ...
    public void beforeMatchFired(BeforeMatchFiredEvent beforeMatchFiredEvent) {
        ...
        auditsMessages.add(generateAuditMessage(ruleKey, ruleExecuted.get(ruleKey)));
    }
