 ...
 *         &lt;element ref="{http://www.dmg.org/PMML-4_0}DefineFunction" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.dmg.org/PMML-4_0}DerivedField" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    protected List<DefineFunction> defineFunctions;
    @XmlElement(name = "DerivedField")
    protected List<DerivedField> derivedFields;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the defineFunctions property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDefineFunctions().add(newItem);
     * </pre>
     * 
     * 
     * <p>
