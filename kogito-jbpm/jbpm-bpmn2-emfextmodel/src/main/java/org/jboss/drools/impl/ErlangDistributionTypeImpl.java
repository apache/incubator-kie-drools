 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.ErlangDistributionTypeImpl#getK <em>K</em>}</li>
 *   <li>{@link org.jboss.drools.impl.ErlangDistributionTypeImpl#getMean <em>Mean</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ErlangDistributionTypeImpl extends DistributionParameterImpl implements ErlangDistributionType {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.ERLANG_DISTRIBUTION_TYPE;
	}
	...
	public void setK(double newK) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.ERLANG_DISTRIBUTION_TYPE__K, oldK, k, !oldKESet));
	}
	...
	public void unsetK() {
		...
		kESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.ERLANG_DISTRIBUTION_TYPE__K, oldK, K_EDEFAULT, oldKESet));
	}
	...
	public void setMean(double newMean) {
		...
		meanESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.ERLANG_DISTRIBUTION_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.ERLANG_DISTRIBUTION_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.ERLANG_DISTRIBUTION_TYPE__K:
				return getK();
			case DroolsPackage.ERLANG_DISTRIBUTION_TYPE__MEAN:
				return getMean();
		}
