...
public class Msg {
    ...
    public static final Message1 ERR_INFERRING_TYPE_REF_FOR_NODE                     = new Message1( DMNMessageType.TYPE_REF_NOT_FOUND, "Error while trying to infer typeRef for node '%s'" );
