...
public class Check2ndNFViolationTest extends AbstractDTAnalysisTest {
    ...
    public void testCheck2ndNFViolation() {
        ...
        DTAnalysis analysisDuplicate = getAnalysis(validate, "_4e358bae-7012-42dd-acea-e88b3aa3c8b2");
        assertThat(analysisDuplicate.is2ndNFViolation(), is(true));
        assertThat(analysisDuplicate.getContractionsViolating2ndNF(), hasSize(1));
        Contraction c2NFViolation = analysisDuplicate.getContractionsViolating2ndNF().iterator().next();
        assertThat(c2NFViolation.rule, is(1));
        assertThat(c2NFViolation.pairedRule, is(2));
