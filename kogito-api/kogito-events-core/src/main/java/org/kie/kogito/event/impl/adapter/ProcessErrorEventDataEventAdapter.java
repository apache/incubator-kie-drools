...
public class ProcessErrorEventDataEventAdapter extends AbstractDataEventAdapter {

    public ProcessErrorEventDataEventAdapter() {
        super(ErrorEvent.class);
    }

    @Override
    public DataEvent<?> adapt(Object payload) {
        ErrorEvent event = (ErrorEvent) payload;
