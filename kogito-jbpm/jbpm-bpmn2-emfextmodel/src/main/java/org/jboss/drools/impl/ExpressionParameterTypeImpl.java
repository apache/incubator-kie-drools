 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.ExpressionParameterTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExpressionParameterTypeImpl extends ParameterValueImpl implements ExpressionParameterType {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.EXPRESSION_PARAMETER_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.EXPRESSION_PARAMETER_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.EXPRESSION_PARAMETER_TYPE__VALUE:
				return getValue();
		}
