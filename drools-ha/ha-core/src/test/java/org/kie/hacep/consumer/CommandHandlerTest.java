...
public class CommandHandlerTest {
  ...
  public void visitInsertCommand() {
    executeAndVerify(new InsertCommand(remoteFactHandle,
                                       myEntryPoint),
                     commandHandler::visit,
                     () -> {
  ...
  public void visitEventInsertCommand() {
    executeAndVerify(new EventInsertCommand(myObject,
                                            myEntryPoint),
                     commandHandler::visit,
                     () -> verify(entryPointMock,
                                  times(1)).insert(eq(myObject)));
  ...
  public void visitUpdateCommand() {
    executeAndVerify(new UpdateCommand(remoteFactHandle,
                                       myObject,
                                       myEntryPoint),
                     commandHandler::visit,
                     () -> {
  ...
  public void visitListObjectsCommandClassType() {
    executeAndVerifyResponseMessage(new ListObjectsCommandClassType(myEntryPoint,
                                                                    String.class),
                                    commandHandler::visit,
                                    ListKieSessionObjectMessage.class,
                                    result -> myObject.equals(((List) result).get(0)));
  ...
  public void visitListObjectsCommandNamedQuery() {
    executeAndVerifyResponseMessage(new ListObjectsCommandNamedQuery(myEntryPoint,
                                                                     namedQuery,
                                                                     objectName),
                                    commandHandler::visit,
                                    ListKieSessionObjectMessage.class,
