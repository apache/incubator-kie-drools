...
public class ReactiveListOld<T> extends AbstractReactiveObject implements List<T> {

    private final List<T> list;

    public ReactiveListOld() {
        this(new ArrayList<T>());
    }

    public ReactiveListOld(List<T> list) {
        this.list = list;
    }
    ...
    public List<T> subList(int fromIndex, int toIndex) {
        return new ReactiveListOld(list.subList(fromIndex, toIndex));
    }
}
