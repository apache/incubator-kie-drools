...
public class SingleConstraint7<A, B, C, D, E, F, G> extends AbstractSingleConstraint {
    ...
    public SingleConstraint7( Expr7ViewItemImpl<A, B, C, D, E, F, G> expr) {
        this(expr.getExprId(), expr.getFirstVariable(), expr.getSecondVariable(), expr.getThirdVariable(), expr.getForthVariable(), expr.getFifthVariable(), expr.getSixthVariable(), expr.getSeventhVariable(), expr.getPredicate());
