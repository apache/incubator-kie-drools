...
@AutoProtoSchemaBuilder(includeClasses = {ProtoStreamStoredObject.class, StringAdaptor.class, PersonAdaptor.class},
        dependsOn = AnySchema.class,
        schemaPackageName = "org.drools.reliability.infinispan",
