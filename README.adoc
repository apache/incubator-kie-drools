...
mvn clean install
----
For information about how to set up code style checks, see https://github.com/kiegroup/optaplanner/blob/main/optaplanner-build/optaplanner-ide-config/ide-configuration.adoc[IDE Setup Instructions].
