...
=== {KIE_SERVER} is removed
{KIE_SERVER} is no longer a component of {PRODUCT} 8. See xref:migration-guide/index.adoc#kie-server_migration-guide[Migration guide chapter] for migration.

=== {BUSINESS_CENTRAL} is removed
{BUSINESS_CENTRAL} is no longer a component of {PRODUCT} 8. See xref:migration-guide/index.adoc#business-central_migration-guide[Migration guide chapter] for migration.
