...
/**
 * OptaPlanner representation of a fixed categorical feature
 */
public class FixedCategoricalEntity extends AbstractEntity<String> {

    public FixedCategoricalEntity() {
        super();
    }

    private FixedCategoricalEntity(String originalValue, String featureName) {
        super(originalValue, featureName, true);
    }

    /**
     * Creates a {@link FixedCategoricalEntity}, taking the original input value from the
     * provided {@link Feature}.
     *
     * @param originalFeature Original input {@link Feature}
     */
    public static FixedCategoricalEntity from(Feature originalFeature) {
        return new FixedCategoricalEntity(originalFeature.getValue().asString(), originalFeature.getName());
    }
