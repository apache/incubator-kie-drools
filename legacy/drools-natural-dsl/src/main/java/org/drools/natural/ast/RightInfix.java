 ...
 *
 */
public class RightInfix extends InfixNode 
{

    private List args;
    private int numberOfArgs;    
    
    public RightInfix(String originalVal, String valueFromDictionary, int numArgs) {
    ...
    {                
        BaseSyntaxNode startArg = this.next;
    ...
    public String render()
    {
        ...
        for ( Iterator iter = vars.iterator( ); iter.hasNext( ); )
        {
            ...
            if (varName.equals(InfixNode.RIGHT)) {
