...
public class Primitives implements Serializable {
    ...
    public void setPrimitiveBooleanArray(final boolean[] primitiveBooleanArray) {
    ...
    public void setPrimitiveShortArray(final short[] primitiveShortArray) {
    ...
    public void setPrimitiveLongArray(final long[] primitiveLongArray) {
    ...
    public void setPrimitiveFloatArray(final float[] floatDoubleArray) {
    ...
    public void setPrimitiveDoubleArray(final double[] primitiveDoubleArrayAttribute) {
    ...
    public int hashCode() {
        ...
        final long doubeAsLongBits = Double.doubleToLongBits(doublePrimitive );
    ...
    public boolean equals(final Object obj) {
        ...
        if ( stringAttribute == null ) {
            ...
            return stringAttribute.equals(other.stringAttribute);
        }
    }
