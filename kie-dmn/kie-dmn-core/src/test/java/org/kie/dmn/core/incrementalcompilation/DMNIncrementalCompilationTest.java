...
//
//public class DMNIncrementalCompilationTest extends BaseVariantTest {
//
//    public static final Logger LOG = LoggerFactory.getLogger(DMNIncrementalCompilationTest.class);
//
//    public DMNIncrementalCompilationTest(final BaseVariantTest.VariantTestConf useExecModelCompiler) {
