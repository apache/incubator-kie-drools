...
public class SingleConstraint16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> extends AbstractSingleConstraint {
    ...
    public SingleConstraint16(Variable<A> var1, Variable<B> var2, Variable<C> var3, Variable<D> var4, Variable<E> var5,
                              ...
                              Variable<N> var14, Variable<O> var15, Variable<P> var16,
    ...
    public SingleConstraint16(String exprId, Variable<A> var1, Variable<B> var2, Variable<C> var3, Variable<D> var4,
    ...
    public SingleConstraint16(Expr16ViewItemImpl<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> expr) {
        this(expr.getExprId(), expr.getFirstVariable(), expr.getVar2(), expr.getVar3(), expr.getVar4(),
                ...
                expr.getVar15(), expr.getVar16(), expr.getPredicate());
        setReactivitySpecs(expr.getReactivitySpecs());
    }

    @Override
    public Variable[] getVariables() {
        return new Variable[]{var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15, var16};
    }
    ...
    public boolean isEqualTo(ModelComponent o) {
        ...
        SingleConstraint16<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> that = (SingleConstraint16<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
    ...
    @Override
    public SingleConstraint16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> negate() {
        return negate(new SingleConstraint16<>("!" + getExprId(), var1, var2, var3, var4, var5, var6, var7,
                var8, var9, var10, var11, var12, var13, var14, var15, var16,
                predicate.negate()));
    }

    @Override
    public SingleConstraint16<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P> replaceVariable(Variable oldVar, Variable newVar) {
        if (var1 == oldVar) {
            return new SingleConstraint16<>(getExprId(), newVar, var2, var3, var4, var5, var6, var7, var8,
                    var9, var10, var11, var12, var13, var14, var15, var16, predicate);
        }
        if (var2 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, newVar, var3, var4, var5, var6, var7, var8,
                    var9, var10, var11, var12, var13, var14, var15, var16, predicate);
        }
        if (var3 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, newVar, var4, var5, var6, var7, var8,
                    var9, var10, var11, var12, var13, var14, var15, var16, predicate);
        }
        if (var4 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, newVar, var5, var6, var7, var8,
                    var9, var10, var11, var12, var13, var14, var15, var16, predicate);
        }
        if (var5 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, newVar, var6, var7, var8,
                    var9, var10, var11, var12, var13, var14, var15, var16, predicate);
        }
        if (var6 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, newVar, var7, var8,
                    var9, var10, var11, var12, var13, var14, var15, var16, predicate);
        }
        if (var7 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, var6, newVar, var8,
                    var9, var10, var11, var12, var13, var14, var15, var16, predicate);
        }
        if (var8 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, var6, var7, newVar,
                    var9, var10, var11, var12, var13, var14, var15, var16, predicate);
        }
        if (var9 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, var6, var7, var8,
                    newVar, var10, var11, var12, var13, var14, var15, var16, predicate);
        }
        if (var10 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, var6, var7, var8,
                    var9, newVar, var11, var12, var13, var14, var15, var16, predicate);
        }
        if (var11 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, var6, var7, var8,
                    var9, var10, newVar, var12, var13, var14, var15, var16, predicate);
        }
        if (var12 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, var6, var7, var8,
                    var9, var10, var11, newVar, var13, var14, var15, var16, predicate);
        }
        if (var13 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, var6, var7, var8,
                    var9, var10, var11, var12, newVar, var14, var15, var16, predicate);
        }
        if (var14 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, var6, var7, var8,
                    var9, var10, var11, var12, var13, newVar, var15, var16, predicate);
        }
        if (var15 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, var6, var7, var8,
                    var9, var10, var11, var12, var13, var14, newVar,var16,  predicate);
        }
        if (var16 == oldVar) {
            return new SingleConstraint16<>(getExprId(), var1, var2, var3, var4, var5, var6, var7, var8,
                    var9, var10, var11, var12, var13, var14, var15, newVar, predicate);
        }
        return this;
    }
}
