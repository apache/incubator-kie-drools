...
public class RuleTemplateModelDRLPersistenceTest {
    ...
    @Test
    public void checkLHSConstraintSeparatorWithTemplateKeyAndIntegerLiteral() {
        FactPattern fp = new FactPattern( "Smurf" );
        fp.setBoundName( "p1" );
        ...
        final String expected2 = "rule \"r2_0\"\n" +
                "  dialect \"mvel\"\n" +
                "  when\n" +
                "    p1 : Smurf( field1 == \"t1\", field1 == 12345, field1 == \"t2\" )\n" +
                "  then\n" +
                "end";
        ...
        final String expected3 = "rule \"r3_0\"\n" +
                "  dialect \"mvel\"\n" +
                "  when\n" +
                "    p1 : Smurf( field1 == \"t1\", field1 == 12345 )\n" +
                "  then\n" +
                "end";
        ...
        final String expected4 = "rule \"r4_0\"\n" +
                "  dialect \"mvel\"\n" +
                "  when\n" +
                "    p1 : Smurf( field1 == 12345, field1 == \"t2\" )\n" +
                "  then\n" +
                "end";
