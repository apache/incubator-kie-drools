...
public class PMMLMiningModelExecutor implements PMMLModelExecutor {
    ...
    @Override
    public PMML4Result evaluate(KiePMMLModel model, PMMLContext context, String releaseId) throws KiePMMLException {
        ...
        return evaluateMiningModel((KiePMMLMiningModel) model, context, releaseId);
    }

    private PMML4Result evaluateMiningModel(KiePMMLMiningModel toEvaluate, PMMLContext pmmlContext, String releaseId) throws KiePMMLException {
    ...
    private Optional<PMML4Result> evaluateSegment(KiePMMLSegment toEvaluate, PMMLContext pmmlContext, String releaseId) throws KiePMMLException {
        ...
        if (kiePMMLPredicate != null && kiePMMLPredicate.evaluate(values)) {
            ...
            toReturn = Optional.of(pmmlRuntime.evaluate(toEvaluate.getModel(), pmmlContext, releaseId));
        }
        return toReturn;
    }
