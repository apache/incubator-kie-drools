...
class DataIndexServiceAvailabilityHealthCheckTest extends AbstractAvailabilityHealthCheckTest {
    @Override
    protected AbstractAvailabilityHealthCheck createHealthCheck(String serviceUrl, Vertx vertxMock, WebClient webClientMock) {
        return new DataIndexAvailabilityHealthCheck(Optional.of(serviceUrl), vertxMock) {
            @Override
