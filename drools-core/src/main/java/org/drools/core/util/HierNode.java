...
//public class HierNode<T> implements Comparable<HierNode<T>>, Externalizable {

        public T value;
        public BitSet bitMask = null;
        public List<T> parents = new ArrayList<T>();
        ...
        public void readExternal( ObjectInput in ) throws IOException, ClassNotFoundException {
            ...
            parents = (List<T>) in.readObject();
            children = (List<T>) in.readObject();
        }
