...
//        }
    ...
    public static class EqualityKeySorter
        ...
        public int compare(EqualityKey key1,
                           EqualityKey key2) {
            return compareLong(key1.getFactHandle().getId(), key2.getFactHandle().getId());
        }
    }
    ...
    public static class HandleSorter
        ...
        public int compare(InternalFactHandle h1,
            ...
            return compareLong(h1.getId(), h2.getId());
        }
    }
            ...
            if ( result == 0 ) {
                ...
                while ( result == 0 && t1 != null && t2 != null ) {
                    if ( t1.getFactHandle() != null && t2.getFactHandle() != null ) {
                        ...
                        result = compareLong(t1.getFactHandle().getId(), t2.getFactHandle().getId());
                    }
                    t1 = t1.getParent();
                    t2 = t2.getParent();
                }
