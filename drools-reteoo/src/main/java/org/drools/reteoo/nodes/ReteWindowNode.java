...
public class ReteWindowNode extends WindowNode
    ...
    public void updateSink(final ObjectSink sink,
        ...
        try {
            ...
            org.drools.core.util.Iterator it = omem.getObjectHashSet().iterator();

            for (ObjectHashSet.ObjectEntry entry = (ObjectHashSet.ObjectEntry) it.next(); entry != null; entry = (ObjectHashSet.ObjectEntry) it.next()) {
