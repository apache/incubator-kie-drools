...
public class ConferenceSchedulingScoreSoftConstraintTest {
    ...
    public void sectorConflict() {
        ...
        scoreVerifier.assertSoftWeight("Sector conflict", 0, solution);
        ...
        scoreVerifier.assertSoftWeight("Sector conflict", -1, solution);
        ...
        scoreVerifier.assertSoftWeight("Sector conflict", -2, solution);
        ...
        scoreVerifier.assertSoftWeight("Sector conflict", -4, solution);
    ...
    public void speakerPreferredTimeslot() {
        ...
        scoreVerifier.assertSoftWeight("Speaker preferred timeslot tag", 0, solution);
        ...
        scoreVerifier.assertSoftWeight("Speaker preferred timeslot tag", -1, solution);
        ...
        scoreVerifier.assertSoftWeight("Speaker preferred timeslot tag", -2, solution);
        ...
        scoreVerifier.assertSoftWeight("Speaker preferred timeslot tag", -4, solution);
        slot1.setTagSet(new HashSet<>(Arrays.asList(tag1)));
        scoreVerifier.assertSoftWeight("Speaker preferred timeslot tag", -2, solution);
        slot1.setTagSet(Collections.emptySet());
        speaker1.setPreferredTimeslotTagSet(new HashSet<>(Arrays.asList(tag1, tag2)));
        ...
        scoreVerifier.assertSoftWeight("Speaker preferred timeslot tag", -3, solution);
    ...
    public void talkPreferredTimeslotTag() {
        ...
        scoreVerifier.assertSoftWeight("Talk preferred timeslot tag", 0, solution);
        ...
        slot1.setTagSet(Collections.emptySet());
        scoreVerifier.assertSoftWeight("Talk preferred timeslot tag", -1, solution);
        slot1.setTagSet(new HashSet<>(Arrays.asList(tag2)));
        scoreVerifier.assertSoftWeight("Talk preferred timeslot tag", -1, solution);
        // talk with preferred time slot tag, time slot without matching tag, weight = 2
        parametrization.setTalkPreferredTimeslotTag(2);
        scoreVerifier.assertSoftWeight("Talk preferred timeslot tag", -2, solution);
    ...
    public void speakerUndesiredTimeslot() {
        ...
        scoreVerifier.assertSoftWeight("Speaker undesired timeslot tag", 0, solution);
        ...
        speaker1.setUndesiredTimeslotTagSet(new HashSet<>(Arrays.asList(tag1)));
        slot1.setTagSet(new HashSet<>(Arrays.asList(tag1)));
        scoreVerifier.assertSoftWeight("Speaker undesired timeslot tag", -1, solution);
        slot1.setTagSet(new HashSet<>(Arrays.asList(tag1, tag2)));
        scoreVerifier.assertSoftWeight("Speaker undesired timeslot tag", -1, solution);
        ...
        scoreVerifier.assertSoftWeight("Speaker undesired timeslot tag", -2, solution);
        ...
        scoreVerifier.assertSoftWeight("Speaker undesired timeslot tag", -2, solution);
        slot1.setTagSet(new HashSet<>(Arrays.asList(tag1, tag2)));
        scoreVerifier.assertSoftWeight("Speaker undesired timeslot tag", -4, solution);
        speaker1.setUndesiredTimeslotTagSet(new HashSet<>(Arrays.asList(tag1, tag2)));
        speaker2.setUndesiredTimeslotTagSet(new HashSet<>(Arrays.asList(tag1, tag3)));
        scoreVerifier.assertSoftWeight("Speaker undesired timeslot tag", -3, solution);
        slot1.setTagSet(new HashSet<>(Arrays.asList(tag1, tag2, tag3)));
        scoreVerifier.assertSoftWeight("Speaker undesired timeslot tag", -4, solution);
    }
    ...
    public void talkUndesiredTimeslotTag() {
        ...
        slot1.setTagSet(Collections.emptySet());
        talk1.withTimeslot(slot1);
        scoreVerifier.assertSoftWeight("Talk undesired timeslot tag", 0, solution);
        slot1.setTagSet(new HashSet<>(Arrays.asList(tag1)));
        ...
        talk1.withTimeslot(slot1).withUndesiredTimeslotTagSet(new HashSet<>(Arrays.asList(tag1)));
        slot1.setTagSet(new HashSet<>(Arrays.asList(tag1)));
        scoreVerifier.assertSoftWeight("Talk undesired timeslot tag", -1, solution);
        slot1.setTagSet(new HashSet<>(Arrays.asList(tag1, tag2)));
        scoreVerifier.assertSoftWeight("Talk undesired timeslot tag", -1, solution);
        // talk with undesired time slot tag, time slot with matching tag, weight = 2
        parametrization.setTalkUndesiredTimeslotTag(2);
        scoreVerifier.assertSoftWeight("Talk undesired timeslot tag", -2, solution);
    ...
    public void speakerPreferredRoomTag() {
        ...
        scoreVerifier.assertSoftWeight("Speaker preferred room tag", 0, solution);
        ...
        scoreVerifier.assertSoftWeight("Speaker preferred room tag", -1, solution);
        ...
        scoreVerifier.assertSoftWeight("Speaker preferred room tag", -2, solution);
        ...
        room1.setTagSet(Collections.emptySet());
        scoreVerifier.assertSoftWeight("Speaker preferred room tag", -3, solution);
        room1.setTagSet(new HashSet<>(Arrays.asList(tag1)));
        scoreVerifier.assertSoftWeight("Speaker preferred room tag", -1, solution);
        room1.setTagSet(new HashSet<>(Arrays.asList(tag1, tag2)));
        scoreVerifier.assertSoftWeight("Speaker preferred room tag", 0, solution);
    ...
    public void talkPreferredRoomTag() {
        ...
        scoreVerifier.assertSoftWeight("Talk preferred room tag", 0, solution);
        ...
        room1.setTagSet(Collections.emptySet());
        scoreVerifier.assertSoftWeight("Talk preferred room tag", -1, solution);
        room1.setTagSet(new HashSet<>(Arrays.asList(tag2)));
        scoreVerifier.assertSoftWeight("Talk preferred room tag", -1, solution);
        // talk with preferred room tag, room without matching tag, weight = 2
        parametrization.setTalkPreferredRoomTag(2);
        scoreVerifier.assertSoftWeight("Talk preferred room tag", -2, solution);
    ...
    public void speakerUndesiredRoomTag() {
        ...
        scoreVerifier.assertSoftWeight("Speaker undesired room tag", 0, solution);
        ...
        speaker1.withUndesiredRoomTagSet(new HashSet<>(Arrays.asList(tag1)));
        room1.setTagSet(new HashSet<>(Arrays.asList(tag1)));
        scoreVerifier.assertSoftWeight("Speaker undesired room tag", -1, solution);
        ...
        scoreVerifier.assertSoftWeight("Speaker undesired room tag", -2, solution);
        ...
        scoreVerifier.assertSoftWeight("Speaker undesired room tag", -2, solution);
        room1.setTagSet(new HashSet<>(Arrays.asList(tag1, tag2)));
        scoreVerifier.assertSoftWeight("Speaker undesired room tag", -3, solution);
    }
    ...
    public void talkUndesiredRoomTag() {
        ...
        room1.setTagSet(Collections.emptySet());
        talk1.withRoom(room1);
        scoreVerifier.assertSoftWeight("Talk undesired room tag", 0, solution);
        room1.setTagSet(new HashSet<>(Arrays.asList(tag1)));
        scoreVerifier.assertSoftWeight("Talk undesired room tag", 0, solution);
        ...
        talk1.withUndesiredRoomTagSet(new HashSet<>(Arrays.asList(tag1)));
        room1.setTagSet(new HashSet<>(Arrays.asList(tag1)));
        scoreVerifier.assertSoftWeight("Talk undesired room tag", -1, solution);
        // talk with undesired room tag, room with matching tag, weight = 2
        parametrization.setTalkUndesiredRoomTag(2);
        scoreVerifier.assertSoftWeight("Talk undesired room tag", -2, solution);
