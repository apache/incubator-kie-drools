 ...
 *
 */
public class SharedNode2CEPerformanceTest extends TestCase {
	public SharedNode2CEPerformanceTest() {
		super();
	}
    ...
    private static RuleBase readRule(String file) throws IOException, DroolsParserException, RuleIntegrationException, PackageIntegrationException, InvalidPatternException {
        ...
        Reader reader = 
        	new InputStreamReader( 
        			SharedNode2CEPerformanceTest.class.getResourceAsStream( file ) );
