...
class TimeFunctionTest {
    ...
    void invokeWithZonedDateTime() {
        FormattedZonedDateTime from = (FormattedZonedDateTime) DateAndTimeFunction.INSTANCE.invoke("2017-08-10T10:20:00@Europe/Paris")
                .getOrElse(null);
    ...
    void getFormattedStringFromTemporalAccessorAndZone() {
        FormattedZonedDateTime date = (FormattedZonedDateTime) DateAndTimeFunction.INSTANCE.invoke("2017-08-10T10:20:10@Europe/Paris")
                .getOrElse(null);
        ...
        date = (FormattedZonedDateTime) DateAndTimeFunction.INSTANCE.invoke("2017-08-10T10:20:00@Europe/Paris").getOrElse(null);
        assertThat(date).isNotNull();
