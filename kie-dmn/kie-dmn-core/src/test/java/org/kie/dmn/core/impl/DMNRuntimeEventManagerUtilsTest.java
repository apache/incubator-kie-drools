...
class DMNRuntimeEventManagerUtilsTest {
    ...
    void testEvaluateConditionalEvent() {
        ...
        String ifId = "_63C5E174-D55D-4C52-95A1-8ED3FACF44FA";
        String thenId = "_1B74D6B2-C69A-4A50-A94A-DD55CC188EC4";
        ...
        assertThat(evaluateConditionalEvent).isNotNull();
        assertThat(evaluateConditionalEvent.getExecutedId()).isEqualTo(ifId);
        ...
        assertThat(conditionalEvaluationEvent.getExecutedId()).isEqualTo(thenId);
