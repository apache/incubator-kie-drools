// $ANTLR 3.5 src/main/resources/org/drools/compiler/semantics/java/parser/Java.g 2016-06-13 19:05:57
...
public class JavaLexer extends Lexer {
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/resources/org/drools/compiler/semantics/java/parser/Java.g:1379:5: ( ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' ) )
			// src/main/resources/org/drools/compiler/semantics/java/parser/Java.g:1379:8: ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )
			{
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/resources/org/drools/compiler/semantics/java/parser/Java.g:1383:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// src/main/resources/org/drools/compiler/semantics/java/parser/Java.g:1383:9: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// src/main/resources/org/drools/compiler/semantics/java/parser/Java.g:1383:14: ( options {greedy=false; } : . )*
			loop29:
			while (true) {
				int alt29=2;
				...
				switch (alt29) {
				case 1 :
					// src/main/resources/org/drools/compiler/semantics/java/parser/Java.g:1383:42: .
					{
					matchAny(); 
					}
					break;
	...
	public final void mLINE_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/resources/org/drools/compiler/semantics/java/parser/Java.g:1387:5: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' )
			// src/main/resources/org/drools/compiler/semantics/java/parser/Java.g:1387:7: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
			{
			match("//"); 

			// src/main/resources/org/drools/compiler/semantics/java/parser/Java.g:1387:12: (~ ( '\\n' | '\\r' ) )*
			loop30:
			while (true) {
				int alt30=2;
			...
			// src/main/resources/org/drools/compiler/semantics/java/parser/Java.g:1387:26: ( '\\r' )?
			int alt31=2;
