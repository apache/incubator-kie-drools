...
public class TestdataLegacyExtendedPinnedEntity extends TestdataLegacyPinnedEntity {
    ...
    public static EntityDescriptor buildEntityDescriptor() {
        ...
        return solutionDescriptor.findEntityDescriptorOrFail(TestdataLegacyExtendedPinnedEntity.class);
    }
    ...
    public TestdataLegacyExtendedPinnedEntity(String code) {
        super(code);
    }

    public TestdataLegacyExtendedPinnedEntity(String code, TestdataValue value, TestdataValue subValue) {
        super(code, value);
        this.subValue = subValue;
    }

    public TestdataLegacyExtendedPinnedEntity(String code, TestdataValue value, boolean locked, boolean pinned,
