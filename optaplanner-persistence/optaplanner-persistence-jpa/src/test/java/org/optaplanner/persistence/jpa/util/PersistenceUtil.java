 ...
 */
package org.optaplanner.persistence.jpa.util;
...
public class PersistenceUtil {
    ...
    public static String DATASOURCE = "org.optaplanner.persistence.datasource";
     ...
     *            {@link org.optaplanner.persistence.jpa.util.PersistenceUtil setupWithPoolingDataSource(String)}
     *
     */
    ...
    private static Properties getDefaultProperties() {
        if (defaultProperties == null) {
            ...
            String[] defaultPropArr = { "", "", "", "jdbc:h2:tcp://localhost/JPAOptaplannerTest", "sa", "", "org.h2.Driver",
   ...
   private static class TestH2Server {
       ...
       public void start() {
           if (realH2Server == null || !realH2Server.isRunning(false)) {
               try {
                   DeleteDbFiles.execute("", "JPAOptaplannerTest", true);
