...
public class FEELRangesTest extends BaseFEELTest {
    ...
    private static Collection<Object[]> data() {
        final Object[][] cases = new Object[][]{
                   {"(=10)", new RangeImpl(Range.RangeBoundary.OPEN, BigDecimal.ONE, new UndefinedValueComparable(), Range.RangeBoundary.OPEN), null},
...
//                 {"(< 10) = (null..10)", Boolean.FALSE, null},
//                 {"(=10) = (10..10)", Boolean.FALSE, null}
        };
