// $ANTLR 3.5 src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g 2014-02-04 17:04:52
...
public class DSLMapLexer extends Lexer {
	...
	public final void mWS() throws RecognitionException {
		try {
			...
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:272:9: ( ( ' ' | '\\t' | '\\f' )+ )
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:272:17: ( ' ' | '\\t' | '\\f' )+
			{
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:272:17: ( ' ' | '\\t' | '\\f' )+
			int cnt1=0;
			loop1:
	...
	public final void mEOL() throws RecognitionException {
		try {
			int _type = EOL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:279:6: ( ( ( '\\r\\n' )=> '\\r\\n' | '\\r' | '\\n' ) )
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:280:12: ( ( '\\r\\n' )=> '\\r\\n' | '\\r' | '\\n' )
			{
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:280:12: ( ( '\\r\\n' )=> '\\r\\n' | '\\r' | '\\n' )
			int alt2=3;
			...
			switch (alt2) {
				case 1 :
					// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:280:20: ( '\\r\\n' )=> '\\r\\n'
					{
					...
					break;
				case 2 :
					// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:281:25: '\\r'
					{
					match('\r'); if (state.failed) return;
					}
					break;
				case 3 :
					// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:282:25: '\\n'
					{
					match('\n'); if (state.failed) return;
					}
					break;
	...
	public final void mEscapeSequence() throws RecognitionException {
		try {
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:289:5: ( '\\\\' ( 'b' | 'B' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' | '.' | 'o' | 'x' | 'a' | 'e' | 'c' | 'd' | 'D' | 's' | 'S' | 'w' | 'W' | 'p' | 'A' | 'G' | 'Z' | 'z' | 'Q' | 'E' | '*' | '[' | ']' | '(' | ')' | '$' | '^' | '{' | '}' | '?' | '+' | '-' | '&' | '|' | '=' | 'u' | '0' | '#' ) )
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:289:9: '\\\\' ( 'b' | 'B' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' | '.' | 'o' | 'x' | 'a' | 'e' | 'c' | 'd' | 'D' | 's' | 'S' | 'w' | 'W' | 'p' | 'A' | 'G' | 'Z' | 'z' | 'Q' | 'E' | '*' | '[' | ']' | '(' | ')' | '$' | '^' | '{' | '}' | '?' | '+' | '-' | '&' | '|' | '=' | 'u' | '0' | '#' )
			{
	...
	public final void mRIGHT_CURLY() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:307:9: ( '}' )
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:307:11: '}'
			{
			match('}'); if (state.failed) return;
			}
	...
	public final void mEQUALS() throws RecognitionException {
		try {
			int _type = EQUALS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:310:8: ( '=' )
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:310:10: '='
			{
			match('='); if (state.failed) return;
			}
	...
	public final void mDOT() throws RecognitionException {
		try {
			int _type = DOT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:313:5: ( '.' )
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:313:7: '.'
			{
			match('.'); if (state.failed) return;
			}
	...
	public final void mCOLON() throws RecognitionException {
		try {
			int _type = COLON;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:316:7: ( ':' )
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:316:9: ':'
			{
			match(':'); if (state.failed) return;
			}
	...
	public final void mCOMMA() throws RecognitionException {
		try {
			int _type = COMMA;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:319:7: ( ',' )
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:319:9: ','
			{
			match(','); if (state.failed) return;
			}
	...
	public final void mLITERAL() throws RecognitionException {
		try {
			int _type = LITERAL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:323:5: ( ( IdentifierPart | MISC | EscapeSequence | DOT )+ )
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:323:7: ( IdentifierPart | MISC | EscapeSequence | DOT )+
			{
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:323:7: ( IdentifierPart | MISC | EscapeSequence | DOT )+
			int cnt3=0;
			loop3:
			while (true) {
				...
				switch (alt3) {
				case 1 :
					// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:323:8: IdentifierPart
					{
					...
					break;
				case 2 :
					// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:323:23: MISC
					{
					...
					break;
				case 3 :
					// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:323:28: EscapeSequence
					{
					...
					break;
				case 4 :
					// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:323:43: DOT
					{
	...
	public final void mMISC() throws RecognitionException {
		try {
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:328:7: ( '>' | '<' | '!' | '@' | '%' | '^' | '*' | '-' | '+' | '?' | COMMA | '/' | '\\'' | '\"' | '|' | '&' | '(' | ')' | ';' | '#' | '~' )
			// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:
			{
	...
	public final void synpred1_DSLMap_fragment() throws RecognitionException {
		// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:280:20: ( '\\r\\n' )
		// src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g:280:22: '\\r\\n'
		{
		match("\r\n"); if (state.failed) return;
