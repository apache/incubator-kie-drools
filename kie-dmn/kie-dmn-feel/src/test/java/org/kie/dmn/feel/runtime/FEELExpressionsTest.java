...
public class FEELExpressionsTest extends BaseFEELTest {
    ...
    private static Collection<Object[]> data() {
        Arrays.asList(new FEELFunction.Param("a",
                                             BuiltInType.UNKNOWN),
                      new FEELFunction.Param("b", BuiltInType.UNKNOWN));
        final Object[][] cases = new Object[][] {
                //                {"{ hello : function() \"Hello World!\"}.hello()", "Hello World!", null},
                {"{ sum : function(a, b) a + b}.sum(3, 4)", BigDecimal.valueOf(7), null},
//                {"function(a, b) a + b", new CustomFEELFunction("<anonymous>",
//                                                                Arrays.asList(new FEELFunction.Param("a",
//                                                                                                     BuiltInType.UNKNOWN),
//                                                                              new FEELFunction.Param("b",
//                                                                                                     BuiltInType.UNKNOWN)),
//                                                                (BaseNode) null,
//                                                                null), null},
//                {"\"b\" in [\"a\", \"b\"]", Boolean.TRUE, null},
//                {"47 in [2, 5, 47]", Boolean.TRUE, null},
//                {"\"b\" in \"a\"", Boolean.FALSE, null},
//                {"47 in 2", Boolean.FALSE, null},
//                {"[\"a\", \"b\"]", Arrays.asList("a", "b"), null},
//                {"[0, 1]", Arrays.asList(BigDecimal.ZERO, BigDecimal.ONE), null},
//                {"\"Hello\"", "Hello", null},
//                {"1", BigDecimal.ONE, null}
...
//                {"{ is minor : function( foo, person's age ) foo = null and person's age < 18, bob is minor : is
//                minor( person's age : 16 ) }.bob is minor", Boolean.TRUE , null},
//                {"{ is eighteen : function( foo, person's age ) foo = null and person's age = 18, bob is eighteen :
//                is eighteen( person's age : 18 ) }.bob is eighteen", Boolean.TRUE , null},
//                {"{ is not eighteen : function( foo, person's age ) foo = null and person's age != 18, bob is not
//                eighteen : is not eighteen( person's age : 17 ) }.bob is not eighteen", Boolean.TRUE , null},
//
...
//                {"{ is not eighteen : != 18, bob is not eighteen : is not eighteen(18) }.bob is not eighteen",
//                Boolean.FALSE , null},
//                {"{ is not eighteen : != 18, bob is not eighteen : is not eighteen(17) }.bob is not eighteen",
//                Boolean.TRUE , null},
//
//                // negated unary tests
...
//                {"{ test : > x, y : 20, x : 10, result : y in ( test ) }.result", Boolean.FALSE, FEELEvent.Severity
//                .ERROR},
...
//                {"{ test : in x, y : 20, x : [10, 20, 30], result : test( y ) }.result", null, FEELEvent.Severity
//                .ERROR},
//
...
//                {"{ someNestedList : { theList : [1, 2, 3] } , x : 2, result : x in someNestedList.theList }
//                .result", Boolean.TRUE , null},
//                {"47 in 2", Boolean.FALSE , null},
...
//                {"{ someNestedList : { theList : [1, 2, 3] } , x : 47, result : x in someNestedList.theList }
//                .result", Boolean.FALSE , null},
//                {"{ exp: 2, v: 3, r: exp**v}.r", BigDecimal.valueOf(8), null},
//                {"{Principal: 12, Rate: 1, Fees: 1, Term: -1, R: (Principal*Rate/12)/(1-(1+Rate/12)**-Term)+Fees}
//                .R", new BigDecimal("-11.00000000000000000000000000000005"), null},
