 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.TriangularDistributionTypeImpl#getMax <em>Max</em>}</li>
 *   <li>{@link org.jboss.drools.impl.TriangularDistributionTypeImpl#getMin <em>Min</em>}</li>
 *   <li>{@link org.jboss.drools.impl.TriangularDistributionTypeImpl#getMostLikely <em>Most Likely</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TriangularDistributionTypeImpl extends DistributionParameterImpl implements TriangularDistributionType {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.TRIANGULAR_DISTRIBUTION_TYPE;
	}
	...
	public void setMax(double newMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TRIANGULAR_DISTRIBUTION_TYPE__MAX, oldMax, max, !oldMaxESet));
	}
	...
	public void unsetMax() {
		...
		maxESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.TRIANGULAR_DISTRIBUTION_TYPE__MAX, oldMax, MAX_EDEFAULT, oldMaxESet));
	}
	...
	public void setMin(double newMin) {
		...
		minESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TRIANGULAR_DISTRIBUTION_TYPE__MIN, oldMin, min, !oldMinESet));
	}
	...
	public void unsetMin() {
		...
		minESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.TRIANGULAR_DISTRIBUTION_TYPE__MIN, oldMin, MIN_EDEFAULT, oldMinESet));
	}
	...
	public void setMostLikely(double newMostLikely) {
		...
		mostLikelyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.TRIANGULAR_DISTRIBUTION_TYPE__MOST_LIKELY, oldMostLikely, mostLikely, !oldMostLikelyESet));
	}
	...
	public void unsetMostLikely() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.TRIANGULAR_DISTRIBUTION_TYPE__MOST_LIKELY, oldMostLikely, MOST_LIKELY_EDEFAULT, oldMostLikelyESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.TRIANGULAR_DISTRIBUTION_TYPE__MAX:
				return getMax();
			case DroolsPackage.TRIANGULAR_DISTRIBUTION_TYPE__MIN:
				return getMin();
			case DroolsPackage.TRIANGULAR_DISTRIBUTION_TYPE__MOST_LIKELY:
