...
public final class BooleanPropertySetterFactory extends PropertySetterFactory<ObjectBooleanConsumer> {
    ...
    protected BooleanPropertySetterFactory(Method setterMethod,
                                           Class<?> propertyType,
    ...
    protected ObjectBooleanConsumer functionFromCallSite(CallSite setterSite) throws Throwable {
        return (ObjectBooleanConsumer) setterSite.getTarget().invokeExact();
    }
    ...
    protected class BooleanUnboxingSetterFunction implements BiConsumer<Object, Object> {
        ...
        public void accept(Object bean, Object value) {
            setterFunction.accept(bean, (boolean) value);
        }
    }
}
