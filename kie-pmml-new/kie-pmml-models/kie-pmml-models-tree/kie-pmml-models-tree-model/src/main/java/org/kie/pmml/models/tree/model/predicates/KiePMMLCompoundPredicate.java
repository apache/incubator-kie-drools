...
public class KiePMMLCompoundPredicate extends KiePMMLPredicate {
    ...
    private KiePMMLCompoundPredicate(String name, List<KiePMMLExtension> extensions, BOOLEAN_OPERATOR booleanOperator) {
     ...
     * @return
     */
    public static Builder builder(String name, List<KiePMMLExtension> extensions, BOOLEAN_OPERATOR booleanOperator) {
        return new Builder(name, extensions, booleanOperator);
    }
    ...
    public static class Builder extends KiePMMLPredicate.Builder<KiePMMLCompoundPredicate> {
        ...
        private Builder(String name, List<KiePMMLExtension> extensions, BOOLEAN_OPERATOR booleanOperator) {
            super("CompoundPredicate-", () -> new KiePMMLCompoundPredicate(name, extensions, booleanOperator));
