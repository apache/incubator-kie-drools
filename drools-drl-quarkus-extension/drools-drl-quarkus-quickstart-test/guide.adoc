...
However, you can go explore the original example at the following link: https://github.com/kiegroup/drools/tree/main/drools-drl-quarkus-extension/drools-drl-quarkus-quickstart-test
...
When you have your Quarkus project configured, you can add the Drools Quarkus extensions to your project by running by adding the following dependencies to your `pom.xml`:
