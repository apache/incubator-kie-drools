...
* _Planning entity_: the class (or classes) that Planner can change during solving. In this example, it is the class ``Process``, because Planner can move processes to different computers.
