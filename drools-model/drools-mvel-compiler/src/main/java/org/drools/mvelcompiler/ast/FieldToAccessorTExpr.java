...
public class FieldToAccessorTExpr implements TypedExpression {
    ...
    public Node toJavaExpression() {
        ...
        if(rhsType.isPresent() && (rhsType.get().equals(BigDecimal.class) && !type.equals(BigDecimal.class)
                                    || rhsType.get().equals(BigInteger.class) && !type.equals(BigInteger.class))) {
            Expression coercedExpression = new BigNumberArgumentCoercion().coercedArgument((Class<?>) rhsType.get(), (Class<?>)type, expressionArguments.get(0));
