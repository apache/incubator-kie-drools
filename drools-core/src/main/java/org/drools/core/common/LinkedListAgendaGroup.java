 ...
 * @see ActivationQueue
 */
public class LinkedListAgendaGroup
    implements
    InternalAgendaGroup {
     ...
     */
    public LinkedListAgendaGroup() {

    }

    public LinkedListAgendaGroup(final String name,
    ...
    public boolean equals(final Object object) {
        if ( (object == null) || !(object instanceof LinkedListAgendaGroup) ) {
            return false;
        }

        if ( ((LinkedListAgendaGroup) object).name.equals( this.name ) ) {
            return true;
        }
