...
class RoundHalfUpFunctionTest {
    ...
    private static final RoundHalfUpFunction roundHalfUpFunction = RoundHalfUpFunction.INSTANCE;

    @Test
    void invokeNull() {
        FunctionTestUtil.assertResultError(roundHalfUpFunction.invoke(null), InvalidParametersEvent.class);
        FunctionTestUtil.assertResultError(roundHalfUpFunction.invoke((BigDecimal) null, null),
                                           InvalidParametersEvent.class);
        FunctionTestUtil.assertResultError(roundHalfUpFunction.invoke(BigDecimal.ONE, null),
                                           InvalidParametersEvent.class);
        FunctionTestUtil.assertResultError(roundHalfUpFunction.invoke(null, BigDecimal.ONE),
                                           InvalidParametersEvent.class);
    }
    ...
    void invokeRoundingOdd() {
        ...
        FunctionTestUtil.assertResult(roundHalfUpFunction.invoke(BigDecimal.valueOf(10.35), BigDecimal.ONE),
