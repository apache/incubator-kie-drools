...
import org.kie.kogito.index.quarkus.json.ObjectMapperProducer;
...
class KogitoIndexEventConverterTest {
    ...
    private QuarkusIndexEventConverter converter;
    ...
    void setUp() {
        ...
        converter = new QuarkusIndexEventConverter(objectMapper);
        converter.init();
    }
