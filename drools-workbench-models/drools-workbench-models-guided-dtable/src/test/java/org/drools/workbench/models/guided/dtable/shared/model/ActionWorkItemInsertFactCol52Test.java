...
import static org.drools.workbench.models.guided.dtable.shared.model.ActionWorkItemInsertFactCol52.FIELD_PARAMETER_CLASSNAME;
import static org.drools.workbench.models.guided.dtable.shared.model.ActionWorkItemInsertFactCol52.FIELD_WORK_ITEM_NAME;
import static org.drools.workbench.models.guided.dtable.shared.model.ActionWorkItemInsertFactCol52.FIELD_WORK_ITEM_RESULT_PARAM_NAME;
...
public class ActionWorkItemInsertFactCol52Test extends ColumnTestBase {
    ...
    @Before
    public void setup() {
        column1 = new ActionWorkItemInsertFactCol52();
        ...
        column2 = new ActionWorkItemInsertFactCol52();
    ...
    public void testDiffAll() {
        ...
        assertEquals(FIELD_WORK_ITEM_NAME, diff.get(9).getFieldName());
        assertEquals("WID1", diff.get(9).getOldValue());
        assertEquals("WID2", diff.get(9).getValue());
        assertEquals(FIELD_WORK_ITEM_RESULT_PARAM_NAME, diff.get(10).getFieldName());
        assertEquals("param1", diff.get(10).getOldValue());
        assertEquals("param2", diff.get(10).getValue());
