...
class BetaMemory
     ...
     */
    public Iterator leftTupleIterator(WorkingMemory wm,
     ...
     */
    Iterator rightObjectIterator(WorkingMemory wm,
                                 ReteTuple tuple) {
     ...
     */
    ObjectMatches add(WorkingMemory wm,
                      FactHandleImpl handle) {
     ...
     */
    ObjectMatches remove(WorkingMemory wm,
                         FactHandleImpl handle) {
