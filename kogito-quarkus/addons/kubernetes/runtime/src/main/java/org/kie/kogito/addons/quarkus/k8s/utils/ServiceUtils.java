...
public final class ServiceUtils {
     ...
     */
    public static Optional<URI> queryServiceByName(KubernetesClient client, KubeURI kubeURI) {
     ...
     */
    public static Optional<URI> queryServiceByLabelOrSelector(KubernetesClient client, Map<String, String> labels,
            Map<String, String> selector, KubeURI kubeURI) {
     ...
     */
    public static Optional<URI> getURLFromService(Service service, KubeURI kubeURI) {
