...
//
//public class DMNUpdateTest extends BaseVariantTestCanonicalKieModule {
//
//    public static final Logger LOG = LoggerFactory.getLogger(DMNUpdateTest.class);
//
//    public DMNUpdateTest(final BaseVariantTest.VariantTestConf useExecModelCompiler, boolean canonicalKieModule) {
