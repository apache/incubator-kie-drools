 ...
 *         &lt;element ref="{http://www.dmg.org/PMML-4_0}PPCell" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PPMatrix implements Serializable
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ppCells property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPPCells().add(newItem);
     * </pre>
     * 
     * 
     * <p>
