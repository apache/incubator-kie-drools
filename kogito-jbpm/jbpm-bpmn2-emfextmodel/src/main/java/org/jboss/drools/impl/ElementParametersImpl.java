 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.ElementParametersImpl#getTimeParameters <em>Time Parameters</em>}</li>
 *   <li>{@link org.jboss.drools.impl.ElementParametersImpl#getControlParameters <em>Control Parameters</em>}</li>
...
public class ElementParametersImpl extends EObjectImpl implements ElementParameters {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.ELEMENT_PARAMETERS;
	}
	...
	public NotificationChain basicSetTimeParameters(TimeParameters newTimeParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__TIME_PARAMETERS, oldTimeParameters, newTimeParameters);
	...
	public void setTimeParameters(TimeParameters newTimeParameters) {
		if (newTimeParameters != timeParameters) {
			...
			if (timeParameters != null)
				msgs = ((InternalEObject)timeParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.ELEMENT_PARAMETERS__TIME_PARAMETERS, null, msgs);
			if (newTimeParameters != null)
				msgs = ((InternalEObject)newTimeParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.ELEMENT_PARAMETERS__TIME_PARAMETERS, null, msgs);
			msgs = basicSetTimeParameters(newTimeParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__TIME_PARAMETERS, newTimeParameters, newTimeParameters));
	}
	...
	public NotificationChain basicSetControlParameters(ControlParameters newControlParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__CONTROL_PARAMETERS, oldControlParameters, newControlParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setControlParameters(ControlParameters newControlParameters) {
		if (newControlParameters != controlParameters) {
			...
			if (controlParameters != null)
				msgs = ((InternalEObject)controlParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.ELEMENT_PARAMETERS__CONTROL_PARAMETERS, null, msgs);
			if (newControlParameters != null)
				msgs = ((InternalEObject)newControlParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.ELEMENT_PARAMETERS__CONTROL_PARAMETERS, null, msgs);
			msgs = basicSetControlParameters(newControlParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__CONTROL_PARAMETERS, newControlParameters, newControlParameters));
	}
	...
	public NotificationChain basicSetResourceParameters(ResourceParameters newResourceParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__RESOURCE_PARAMETERS, oldResourceParameters, newResourceParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setResourceParameters(ResourceParameters newResourceParameters) {
		if (newResourceParameters != resourceParameters) {
			...
			if (resourceParameters != null)
				msgs = ((InternalEObject)resourceParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.ELEMENT_PARAMETERS__RESOURCE_PARAMETERS, null, msgs);
			if (newResourceParameters != null)
				msgs = ((InternalEObject)newResourceParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.ELEMENT_PARAMETERS__RESOURCE_PARAMETERS, null, msgs);
			msgs = basicSetResourceParameters(newResourceParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__RESOURCE_PARAMETERS, newResourceParameters, newResourceParameters));
	}
	...
	public NotificationChain basicSetPriorityParameters(PriorityParameters newPriorityParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__PRIORITY_PARAMETERS, oldPriorityParameters, newPriorityParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPriorityParameters(PriorityParameters newPriorityParameters) {
		if (newPriorityParameters != priorityParameters) {
			...
			if (priorityParameters != null)
				msgs = ((InternalEObject)priorityParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.ELEMENT_PARAMETERS__PRIORITY_PARAMETERS, null, msgs);
			if (newPriorityParameters != null)
				msgs = ((InternalEObject)newPriorityParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.ELEMENT_PARAMETERS__PRIORITY_PARAMETERS, null, msgs);
			msgs = basicSetPriorityParameters(newPriorityParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__PRIORITY_PARAMETERS, newPriorityParameters, newPriorityParameters));
	}
	...
	public NotificationChain basicSetCostParameters(CostParameters newCostParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__COST_PARAMETERS, oldCostParameters, newCostParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCostParameters(CostParameters newCostParameters) {
		if (newCostParameters != costParameters) {
			...
			if (costParameters != null)
				msgs = ((InternalEObject)costParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.ELEMENT_PARAMETERS__COST_PARAMETERS, null, msgs);
			if (newCostParameters != null)
				msgs = ((InternalEObject)newCostParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroolsPackage.ELEMENT_PARAMETERS__COST_PARAMETERS, null, msgs);
			msgs = basicSetCostParameters(newCostParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__COST_PARAMETERS, newCostParameters, newCostParameters));
	}
	...
	public EList<VendorExtension> getVendorExtension() {
		if (vendorExtension == null) {
			vendorExtension = new EObjectContainmentEList<VendorExtension>(VendorExtension.class, this, DroolsPackage.ELEMENT_PARAMETERS__VENDOR_EXTENSION);
		}
	...
	public void setElementId(String newElementId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__ELEMENT_ID, oldElementId, elementId));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.ELEMENT_PARAMETERS__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DroolsPackage.ELEMENT_PARAMETERS__TIME_PARAMETERS:
				return basicSetTimeParameters(null, msgs);
			case DroolsPackage.ELEMENT_PARAMETERS__CONTROL_PARAMETERS:
				return basicSetControlParameters(null, msgs);
			case DroolsPackage.ELEMENT_PARAMETERS__RESOURCE_PARAMETERS:
				return basicSetResourceParameters(null, msgs);
			case DroolsPackage.ELEMENT_PARAMETERS__PRIORITY_PARAMETERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DroolsPackage.ELEMENT_PARAMETERS__ELEMENT_ID:
				return getElementId();
			case DroolsPackage.ELEMENT_PARAMETERS__ID:
				return getId();
		}
