...
public final class Msg {
    ...
    public static final Message3 COMPARISON_OPERATOR_NOT_SUPPORTED_FOR_COLLECTIONS = new Message3("Comparison operator '%s' cannot be applied to collections. Left: %s, Right: %s");
