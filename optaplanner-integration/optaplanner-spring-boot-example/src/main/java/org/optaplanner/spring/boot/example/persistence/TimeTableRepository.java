...
import org.optaplanner.spring.boot.example.domain.TimeTableSolution;
...
public class TimeTableRepository {
    ...
    public void save(TimeTableSolution timeTableSolution) {
        for (Lesson lesson : timeTableSolution.getLessonList()) {
