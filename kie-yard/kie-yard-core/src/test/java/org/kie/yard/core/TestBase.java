...
public class TestBase {
    ...
    protected Map<String, Object> evaluate(String jsonInputCxt, String file) throws Exception {
        ...
        final YaRDResult evaluate = new YaRDRuntime(yamlDecision).evaluate(jsonInputCxt);
        final Map<String, Object> output = evaluate.getOutput();

        final String OUTPUT_JSON = jsonMapper.writerWithDefaultPrettyPrinter().writeValueAsString(output);
        final Map<String, Object> outputJSONasMap = readJSON(OUTPUT_JSON);
