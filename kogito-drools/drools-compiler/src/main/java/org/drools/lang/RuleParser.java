// $ANTLR 3.0ea7 /home/michael/projects/jboss-rules/drools-compiler/src/main/resources/org/drools/lang/drl.g 2006-07-06 23:25:29
...
public class RuleParser extends Parser {
    ...
    // /home/michael/projects/jboss-rules/drools-compiler/src/main/resources/org/drools/lang/drl.g:639:2: fact_expression[String id] returns [PatternDescr pd] : ( '(' fe= fact_expression[id] ')' | f= fact opt_eol ( ('or'|'||') opt_eol f= fact )* );
    public PatternDescr fact_expression(String id) throws RecognitionException {   
        ...
        try {
            // /home/michael/projects/jboss-rules/drools-compiler/src/main/resources/org/drools/lang/drl.g:644:17: ( '(' fe= fact_expression[id] ')' | f= fact opt_eol ( ('or'|'||') opt_eol f= fact )* )
            int alt46=2;
            ...
            if ( LA46_0==23 ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("639:2: fact_expression[String id] returns [PatternDescr pd] : ( \'(\' fe= fact_expression[id] \')\' | f= fact opt_eol ( (\'or\'|\'||\') opt_eol f= fact )* );", 46, 0, input);

                throw nvae;
            }
            switch (alt46) {
                case 1 :
                    // /home/michael/projects/jboss-rules/drools-compiler/src/main/resources/org/drools/lang/drl.g:644:17: '(' fe= fact_expression[id] ')'
                    {
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    if ( (input.LA(1)>=41 && input.LA(1)<=42) ) {
                    	        ...
                    	        MismatchedSetException mse =
                    	            new MismatchedSetException(null,input);
                    	        recoverFromMismatchedSet(input,mse,FOLLOW_set_in_fact_expression1556);    throw mse;
                    	    }


                    	    following.push(FOLLOW_opt_eol_in_fact_expression1561);
                    	    opt_eol();
                    	    following.pop();
                    	    ...
                    	    following.push(FOLLOW_fact_in_fact_expression1575);
                    	    f=fact();
                    	    following.pop();
        ...
        try {
            ...
            switch (alt60) {
                ...
                case 5 :
                    ...
                    following.push(FOLLOW_opt_eol_in_lhs_unary2600);
                    opt_eol();
                    following.pop();


                    following.push(FOLLOW_lhs_in_lhs_unary2604);
                    u=lhs();
                    following.pop();
                    ...
                    match(input,25,FOLLOW_25_in_lhs_unary2608);
    ...
    public PatternDescr lhs_exist() throws RecognitionException {   
        ...
        try {
            ...
            loc=(Token)input.LT(1);
            match(input,56,FOLLOW_56_in_lhs_exist2638);
            ...
            switch (alt61) {
                case 1 :
                    ...
                    match(input,23,FOLLOW_23_in_lhs_exist2641);

                    following.push(FOLLOW_lhs_column_in_lhs_exist2645);
                    column=lhs_column();
                    following.pop();


                    match(input,25,FOLLOW_25_in_lhs_exist2647);
                ...
                case 2 :
                    ...
                    following.push(FOLLOW_lhs_column_in_lhs_exist2653);
                    column=lhs_column();
                    following.pop();
    ...
    public NotDescr lhs_not() throws RecognitionException {   
        ...
        try {
            ...
            loc=(Token)input.LT(1);
            match(input,57,FOLLOW_57_in_lhs_not2683);
            ...
            switch (alt62) {
                case 1 :
                    ...
                    match(input,23,FOLLOW_23_in_lhs_not2686);

                    following.push(FOLLOW_lhs_column_in_lhs_not2690);
                    column=lhs_column();
                    following.pop();


                    match(input,25,FOLLOW_25_in_lhs_not2693);
                ...
                case 2 :
                    ...
                    following.push(FOLLOW_lhs_column_in_lhs_not2699);
                    column=lhs_column();
                    following.pop();
    ...
    public PatternDescr lhs_eval() throws RecognitionException {   
        ...
        try {
            ...
            match(input,58,FOLLOW_58_in_lhs_eval2725);

            loc=(Token)input.LT(1);
            match(input,23,FOLLOW_23_in_lhs_eval2729);

            following.push(FOLLOW_paren_chunk2_in_lhs_eval2737);
            c=paren_chunk2();
            following.pop();


            match(input,25,FOLLOW_25_in_lhs_eval2741);
    ...
    public String dotted_name() throws RecognitionException {   
        ...
        try {
            ...
            id=(Token)input.LT(1);
            match(input,ID,FOLLOW_ID_in_dotted_name2773);
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    match(input,18,FOLLOW_18_in_dotted_name2779);

            	    id=(Token)input.LT(1);
            	    match(input,ID,FOLLOW_ID_in_dotted_name2783);
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    match(input,59,FOLLOW_59_in_dotted_name2792);

            	    match(input,60,FOLLOW_60_in_dotted_name2794);
    ...
    public String argument() throws RecognitionException {   
        ...
        try {
            ...
            id=(Token)input.LT(1);
            match(input,ID,FOLLOW_ID_in_argument2824);
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    match(input,59,FOLLOW_59_in_argument2830);

            	    match(input,60,FOLLOW_60_in_argument2832);
        ...
        try {
            ...
            switch (alt66) {
                case 1 :
                    ...
                    id=(Token)input.LT(1);
                    match(input,ID,FOLLOW_ID_in_word2860);
                ...
                case 2 :
                    ...
                    match(input,17,FOLLOW_17_in_word2872);
                ...
                case 3 :
                    ...
                    match(input,61,FOLLOW_61_in_word2881);
                ...
                case 4 :
                    ...
                    match(input,30,FOLLOW_30_in_word2893);
                ...
                case 5 :
                    ...
                    match(input,28,FOLLOW_28_in_word2904);
                ...
                case 6 :
                    ...
                    match(input,35,FOLLOW_35_in_word2914);
                ...
                case 7 :
                    ...
                    match(input,36,FOLLOW_36_in_word2922);
                ...
                case 8 :
                    ...
                    match(input,31,FOLLOW_31_in_word2930);
                ...
                case 9 :
                    ...
                    match(input,33,FOLLOW_33_in_word2941);
                ...
                case 10 :
                    ...
                    match(input,29,FOLLOW_29_in_word2952);
                ...
                case 11 :
                    ...
                    match(input,STRING,FOLLOW_STRING_in_word2966);
    ...
    class DFA2 extends DFA {
        ...
        DFA.State s87 = new DFA.State() {{alt=1;}};
        ...
        DFA.State s80 = new DFA.State() {
            public DFA.State transition(IntStream input) throws RecognitionException {
                ...
                default:
                    ...
                    NoViableAltException nvae =
                        new NoViableAltException("", 4, 80, input);
    ...
    public static final BitSet FOLLOW_set_in_opt_eol41 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_compilation_unit57 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_prolog_in_compilation_unit61 = new BitSet(new long[]{6455314L});
    public static final BitSet FOLLOW_rule_in_compilation_unit70 = new BitSet(new long[]{6455314L});
    public static final BitSet FOLLOW_query_in_compilation_unit83 = new BitSet(new long[]{6455314L});
    public static final BitSet FOLLOW_extra_statement_in_compilation_unit91 = new BitSet(new long[]{6455314L});
    public static final BitSet FOLLOW_opt_eol_in_prolog115 = new BitSet(new long[]{7569426L});
    public static final BitSet FOLLOW_package_statement_in_prolog123 = new BitSet(new long[]{7503890L});
    public static final BitSet FOLLOW_extra_statement_in_prolog138 = new BitSet(new long[]{7503890L});
    public static final BitSet FOLLOW_expander_in_prolog144 = new BitSet(new long[]{7503890L});
    public static final BitSet FOLLOW_opt_eol_in_prolog156 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_16_in_package_statement180 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_package_statement182 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_dotted_name_in_package_statement186 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_package_statement188 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_package_statement191 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_17_in_import_statement207 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_import_statement209 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_import_name_in_import_statement213 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_import_statement215 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_import_statement218 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_ID_in_import_name249 = new BitSet(new long[]{786434L});
    public static final BitSet FOLLOW_18_in_import_name255 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_ID_in_import_name259 = new BitSet(new long[]{786434L});
    public static final BitSet FOLLOW_19_in_import_name269 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_20_in_expander289 = new BitSet(new long[]{32818L});
    public static final BitSet FOLLOW_dotted_name_in_expander294 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_expander298 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_expander301 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_21_in_global325 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_dotted_name_in_global329 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_ID_in_global333 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_global335 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_global338 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_22_in_function362 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function364 = new BitSet(new long[]{32818L});
    public static final BitSet FOLLOW_dotted_name_in_function369 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function373 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_ID_in_function377 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function379 = new BitSet(new long[]{8388608L});
    public static final BitSet FOLLOW_23_in_function388 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function390 = new BitSet(new long[]{33587250L});
    public static final BitSet FOLLOW_dotted_name_in_function400 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function404 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_argument_in_function408 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function410 = new BitSet(new long[]{50331648L});
    public static final BitSet FOLLOW_24_in_function424 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function426 = new BitSet(new long[]{32818L});
    public static final BitSet FOLLOW_dotted_name_in_function431 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function435 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_argument_in_function439 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function441 = new BitSet(new long[]{50331648L});
    public static final BitSet FOLLOW_25_in_function466 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function470 = new BitSet(new long[]{67108864L});
    public static final BitSet FOLLOW_26_in_function474 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_curly_chunk_in_function481 = new BitSet(new long[]{134217728L});
    public static final BitSet FOLLOW_27_in_function490 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_function498 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_opt_eol_in_query522 = new BitSet(new long[]{268435456L});
    public static final BitSet FOLLOW_28_in_query528 = new BitSet(new long[]{2305843124909506848L});
    public static final BitSet FOLLOW_word_in_query532 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_query534 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_expander_lhs_block_in_query550 = new BitSet(new long[]{536870912L});
    public static final BitSet FOLLOW_normal_lhs_block_in_query558 = new BitSet(new long[]{536870912L});
    public static final BitSet FOLLOW_29_in_query573 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_query575 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_opt_eol_in_rule598 = new BitSet(new long[]{1073741824L});
    public static final BitSet FOLLOW_30_in_rule604 = new BitSet(new long[]{2305843124909506848L});
    public static final BitSet FOLLOW_word_in_rule608 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_rule610 = new BitSet(new long[]{21474869266L});
    public static final BitSet FOLLOW_rule_attributes_in_rule621 = new BitSet(new long[]{32786L});
    ...
    public static final BitSet FOLLOW_32_in_rule642 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_rule645 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_expander_lhs_block_in_rule663 = new BitSet(new long[]{536903698L});
    public static final BitSet FOLLOW_normal_lhs_block_in_rule672 = new BitSet(new long[]{536903698L});
    ...
    public static final BitSet FOLLOW_32_in_rule701 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_rule705 = new BitSet(new long[]{4611686018427387888L});
    public static final BitSet FOLLOW_29_in_rule751 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_rule753 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_import_statement_in_extra_statement773 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_global_in_extra_statement778 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_function_in_extra_statement783 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_34_in_rule_attributes802 = new BitSet(new long[]{4295000082L});
    public static final BitSet FOLLOW_32_in_rule_attributes805 = new BitSet(new long[]{32786L});
    ...
    public static final BitSet FOLLOW_rule_attribute_in_rule_attributes820 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_rule_attributes822 = new BitSet(new long[]{2164680294402L});
    public static final BitSet FOLLOW_salience_in_rule_attribute861 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_no_loop_in_rule_attribute871 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_agenda_group_in_rule_attribute882 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_duration_in_rule_attribute895 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_activation_group_in_rule_attribute909 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_auto_focus_in_rule_attribute920 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_35_in_salience953 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_salience955 = new BitSet(new long[]{64L});
    public static final BitSet FOLLOW_INT_in_salience959 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_salience961 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_salience964 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_36_in_no_loop999 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_no_loop1001 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_no_loop1003 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_no_loop1006 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_36_in_no_loop1031 = new BitSet(new long[]{128L});
    public static final BitSet FOLLOW_BOOL_in_no_loop1035 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_no_loop1037 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_no_loop1039 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_no_loop1042 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_37_in_auto_focus1088 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_auto_focus1090 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_auto_focus1092 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_auto_focus1095 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_37_in_auto_focus1120 = new BitSet(new long[]{128L});
    public static final BitSet FOLLOW_BOOL_in_auto_focus1124 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_auto_focus1126 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_auto_focus1128 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_auto_focus1131 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_38_in_activation_group1173 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_activation_group1175 = new BitSet(new long[]{256L});
    public static final BitSet FOLLOW_STRING_in_activation_group1179 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_activation_group1181 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_activation_group1184 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_39_in_agenda_group1213 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_agenda_group1215 = new BitSet(new long[]{256L});
    public static final BitSet FOLLOW_STRING_in_agenda_group1219 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_agenda_group1221 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_agenda_group1224 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_40_in_duration1256 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_duration1258 = new BitSet(new long[]{64L});
    public static final BitSet FOLLOW_INT_in_duration1262 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_15_in_duration1264 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_duration1267 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_lhs_in_normal_lhs_block1293 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_normal_lhs_block1295 = new BitSet(new long[]{504403158273916978L});
    public static final BitSet FOLLOW_opt_eol_in_normal_lhs_block1307 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_paren_chunk_in_expander_lhs_block1348 = new BitSet(new long[]{16L});
    public static final BitSet FOLLOW_EOL_in_expander_lhs_block1352 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_lhs_or_in_lhs1404 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_fact_binding_in_lhs_column1432 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_fact_in_lhs_column1441 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_ID_in_fact_binding1473 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_fact_binding1483 = new BitSet(new long[]{4294967296L});
    public static final BitSet FOLLOW_32_in_fact_binding1485 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_fact_binding1487 = new BitSet(new long[]{8388640L});
    public static final BitSet FOLLOW_fact_expression_in_fact_binding1491 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_23_in_fact_expression1523 = new BitSet(new long[]{8388640L});
    public static final BitSet FOLLOW_fact_expression_in_fact_expression1527 = new BitSet(new long[]{33554432L});
    public static final BitSet FOLLOW_25_in_fact_expression1530 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_fact_in_fact_expression1541 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_fact_expression1543 = new BitSet(new long[]{6597069766658L});
    public static final BitSet FOLLOW_set_in_fact_expression1556 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_fact_expression1561 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_fact_in_fact_expression1575 = new BitSet(new long[]{6597069766658L});
    public static final BitSet FOLLOW_dotted_name_in_fact1614 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_fact1622 = new BitSet(new long[]{8388608L});
    public static final BitSet FOLLOW_23_in_fact1630 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_fact1633 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_constraints_in_fact1639 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_fact1658 = new BitSet(new long[]{33554432L});
    public static final BitSet FOLLOW_25_in_fact1662 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_fact1664 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_opt_eol_in_constraints1696 = new BitSet(new long[]{32818L});
    public static final BitSet FOLLOW_constraint_in_constraints1701 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_predicate_in_constraints1704 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_constraints1712 = new BitSet(new long[]{16777216L});
    public static final BitSet FOLLOW_24_in_constraints1714 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_constraints1716 = new BitSet(new long[]{32818L});
    public static final BitSet FOLLOW_constraint_in_constraints1719 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_predicate_in_constraints1722 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_constraints1730 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_opt_eol_in_constraint1749 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_ID_in_constraint1757 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_constraint1759 = new BitSet(new long[]{4294967296L});
    public static final BitSet FOLLOW_32_in_constraint1761 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_constraint1763 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_ID_in_constraint1773 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_constraint1783 = new BitSet(new long[]{4494803534381074L});
    public static final BitSet FOLLOW_set_in_constraint1791 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_constraint1878 = new BitSet(new long[]{4503599635760096L});
    public static final BitSet FOLLOW_ID_in_constraint1896 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_enum_constraint_in_constraint1921 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_literal_constraint_in_constraint1953 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_retval_constraint_in_constraint1973 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_constraint2006 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_STRING_in_literal_constraint2033 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_INT_in_literal_constraint2044 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_FLOAT_in_literal_constraint2057 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_BOOL_in_literal_constraint2068 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_52_in_literal_constraint2080 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_ID_in_enum_constraint2111 = new BitSet(new long[]{262144L});
    public static final BitSet FOLLOW_18_in_enum_constraint2113 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_ID_in_enum_constraint2117 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_23_in_retval_constraint2146 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_paren_chunk_in_retval_constraint2150 = new BitSet(new long[]{33554432L});
    public static final BitSet FOLLOW_25_in_retval_constraint2152 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_ID_in_predicate2170 = new BitSet(new long[]{4294967296L});
    public static final BitSet FOLLOW_32_in_predicate2172 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_ID_in_predicate2176 = new BitSet(new long[]{9007199254740992L});
    public static final BitSet FOLLOW_53_in_predicate2178 = new BitSet(new long[]{8388608L});
    public static final BitSet FOLLOW_23_in_predicate2180 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_paren_chunk_in_predicate2184 = new BitSet(new long[]{33554432L});
    public static final BitSet FOLLOW_25_in_predicate2186 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_23_in_paren_chunk2232 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_paren_chunk_in_paren_chunk2236 = new BitSet(new long[]{33554432L});
    public static final BitSet FOLLOW_25_in_paren_chunk2238 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_23_in_paren_chunk22309 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_paren_chunk2_in_paren_chunk22313 = new BitSet(new long[]{33554432L});
    public static final BitSet FOLLOW_25_in_paren_chunk22315 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_26_in_curly_chunk2384 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_curly_chunk_in_curly_chunk2388 = new BitSet(new long[]{134217728L});
    public static final BitSet FOLLOW_27_in_curly_chunk2390 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_lhs_and_in_lhs_or2448 = new BitSet(new long[]{6597069766658L});
    public static final BitSet FOLLOW_set_in_lhs_or2457 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_lhs_or2462 = new BitSet(new long[]{504403158273884192L});
    public static final BitSet FOLLOW_lhs_and_in_lhs_or2469 = new BitSet(new long[]{6597069766658L});
    public static final BitSet FOLLOW_lhs_unary_in_lhs_and2509 = new BitSet(new long[]{54043195528445954L});
    public static final BitSet FOLLOW_set_in_lhs_and2518 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_lhs_and2523 = new BitSet(new long[]{504403158273884192L});
    public static final BitSet FOLLOW_lhs_unary_in_lhs_and2530 = new BitSet(new long[]{54043195528445954L});
    public static final BitSet FOLLOW_lhs_exist_in_lhs_unary2568 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_lhs_not_in_lhs_unary2576 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_lhs_eval_in_lhs_unary2584 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_lhs_column_in_lhs_unary2592 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_23_in_lhs_unary2598 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_lhs_unary2600 = new BitSet(new long[]{504403158273884192L});
    public static final BitSet FOLLOW_lhs_in_lhs_unary2604 = new BitSet(new long[]{32786L});
    public static final BitSet FOLLOW_opt_eol_in_lhs_unary2606 = new BitSet(new long[]{33554432L});
    public static final BitSet FOLLOW_25_in_lhs_unary2608 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_56_in_lhs_exist2638 = new BitSet(new long[]{8388640L});
    public static final BitSet FOLLOW_23_in_lhs_exist2641 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_lhs_column_in_lhs_exist2645 = new BitSet(new long[]{33554432L});
    public static final BitSet FOLLOW_25_in_lhs_exist2647 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_lhs_column_in_lhs_exist2653 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_57_in_lhs_not2683 = new BitSet(new long[]{8388640L});
    public static final BitSet FOLLOW_23_in_lhs_not2686 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_lhs_column_in_lhs_not2690 = new BitSet(new long[]{33554432L});
    public static final BitSet FOLLOW_25_in_lhs_not2693 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_lhs_column_in_lhs_not2699 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_58_in_lhs_eval2725 = new BitSet(new long[]{8388608L});
    public static final BitSet FOLLOW_23_in_lhs_eval2729 = new BitSet(new long[]{4611686018427387890L});
    public static final BitSet FOLLOW_paren_chunk2_in_lhs_eval2737 = new BitSet(new long[]{33554432L});
    public static final BitSet FOLLOW_25_in_lhs_eval2741 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_ID_in_dotted_name2773 = new BitSet(new long[]{576460752303685634L});
    public static final BitSet FOLLOW_18_in_dotted_name2779 = new BitSet(new long[]{32L});
    public static final BitSet FOLLOW_ID_in_dotted_name2783 = new BitSet(new long[]{576460752303685634L});
    public static final BitSet FOLLOW_59_in_dotted_name2792 = new BitSet(new long[]{1152921504606846976L});
    public static final BitSet FOLLOW_60_in_dotted_name2794 = new BitSet(new long[]{576460752303423490L});
    public static final BitSet FOLLOW_ID_in_argument2824 = new BitSet(new long[]{576460752303423490L});
    public static final BitSet FOLLOW_59_in_argument2830 = new BitSet(new long[]{1152921504606846976L});
    public static final BitSet FOLLOW_60_in_argument2832 = new BitSet(new long[]{576460752303423490L});
    public static final BitSet FOLLOW_ID_in_word2860 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_17_in_word2872 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_61_in_word2881 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_30_in_word2893 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_28_in_word2904 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_35_in_word2914 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_36_in_word2922 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_31_in_word2930 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_33_in_word2941 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_29_in_word2952 = new BitSet(new long[]{2L});
    public static final BitSet FOLLOW_STRING_in_word2966 = new BitSet(new long[]{2L});
