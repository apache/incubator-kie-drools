 ...
 * 
 */
public abstract class InfixNode extends BaseSyntaxNode
{
    ...
    private void resetLinks(BaseSyntaxNode currentArg)
    {
    ...
    private void reattachNodesBackward(BaseSyntaxNode currentArg)
    {
    ...
    private void reattachNodesForward(BaseSyntaxNode currentArg)
    {
    ...
    void checkValidArg(BaseSyntaxNode currentNode, int numberOfArgs, Direction direction)
    {
        if ( currentNode == null )
        {
            if (direction == Direction.RIGHT) {
                                               ...
                                               List arguments)
    {
        ...
        BaseSyntaxNode node = (BaseSyntaxNode) arguments.get(--argNum); 
        return node.render();        
    }
