...
import static org.drools.modelcompiler.util.ClassUtil.isAccessiblePropertiesIncludingPrimitiveWrapper;
...
public abstract class AbstractExpressionBuilder {
    ...
    String getIndexIdArgument(SingleDrlxParseSuccess drlxParseResult, TypedExpression left) {
        return isAccessiblePropertiesIncludingPrimitiveWrapper( drlxParseResult.getPatternType(), left.getFieldName() ) ?
