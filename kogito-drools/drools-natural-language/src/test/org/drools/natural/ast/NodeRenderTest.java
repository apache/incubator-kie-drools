...
public class NodeRenderTest extends TestCase
{
    ...
    public void testLeftOnlyNode() {
        LeftOnlyNode node = new LeftOnlyNode("something here", "somethingHere(${-1},${-2})", 2);
    ...
    public void testLeftRightNode() {
        LeftRightNode node = new LeftRightNode("something here", "<<somethingHere(${left},${right})", 1, 1);
    ...
    public void testRightNodeSingleArg() {
        RightOnlyNode node = new RightOnlyNode("something here", "<<${right}.somethingHere()", 1);
    ...
    public void testRightOnlyNode() {
        RightOnlyNode node = new RightOnlyNode("something here", "somethingHere(${1},${2})", 2);
        node.getArguments().add(new LiteralNode("arg1"));
        node.getArguments().add(new LiteralNode("arg2"));
        assertEquals("somethingHere(arg1,arg2)", node.render());        
    }
    ...
    public void testSpaceInsertRightOnlyNode() {
        ...
        RightOnlyNode right = new RightOnlyNode("blah", "blah(${1})", 1);
        ...
        lit1.processLeftToRight(RightOnlyNode.class);
    ...
    public void testGetLeftArgs() {        
        LeftOnlyNode node = new LeftOnlyNode("", "", 1);
