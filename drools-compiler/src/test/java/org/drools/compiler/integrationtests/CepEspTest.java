...
//        assertSame( tick2, stocks[1]);
    ...
    public void testTemporalOperatorWithGlobal() {
        // DROOLS-993
        String drl = "import " + SimpleEvent.class.getCanonicalName() + "\n" +
                     "import " + SessionClock.class.getCanonicalName() + "\n" +
                     "global java.util.List list;\n" +
                     "global " + SessionClock.class.getCanonicalName() + " clock;\n" +
                     "\n" +
                     "declare SimpleEvent\n" +
                     "    @role( event )\n" +
                     "    @timestamp( dateEvt )\n" +
                     ...
                     "rule R \n" +
                     "    when\n" +
                     "        $e : SimpleEvent( dateEvt before[10s] clock.currentTime )\n" +
                     "    then\n" +
                     "        list.add(\"1\");\n" +
                     "    end\n " +
                     "";
    ...
    @Test
    public void testTemporalOperatorWithPatternMatching() {
        // DROOLS-993
        String drl = "import " + SimpleEvent.class.getCanonicalName() + "\n" +
                     "import " + SessionClock.class.getCanonicalName() + "\n" +
                     "global java.util.List list;\n" +
