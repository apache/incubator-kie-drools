...
final class TriConstraintLongConsequence<A, B, C>
        extends AbstractTriConstraintConsequence<A, B, C>
        implements Supplier<ToLongTriFunction<A, B, C>> {

    private final TriLeftHandSide<A, B, C> leftHandSide;
    private final ToLongTriFunction<A, B, C> matchWeighter;

    TriConstraintLongConsequence(TriLeftHandSide<A, B, C> leftHandSide, ToLongTriFunction<A, B, C> matchWeighter) {
