...
public class PersistenceUtil {
     ...
     *            {@link org.drools.persistence.util.PersistenceUtil
     *            setupWithPoolingDataSource(String)}
     * 
     */
    public static void tearDown(HashMap<String, Object> context) {
        if (context != null) {
            Object emfObject = context.get(ENTITY_MANAGER_FACTORY);
            if (emfObject != null) {
                try {
            ...
            Object ds1Object = context.get(DATASOURCE);
            if (ds1Object != null) {
                try {
