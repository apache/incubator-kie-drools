...
public class GetAllGroupAuditTasksByStatusByDueDateCommand extends PaginatedTaskCommand<List<GroupAuditTask>> {
	...
	public GetAllGroupAuditTasksByStatusByDueDateCommand(String groupIds, List<String> statuses, Date dueDate, int offset, int count) {
