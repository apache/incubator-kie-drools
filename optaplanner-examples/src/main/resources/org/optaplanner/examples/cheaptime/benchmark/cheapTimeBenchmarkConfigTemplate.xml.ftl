...
<plannerBenchmark>
  ...
  <inheritedSolverBenchmark>
    <problemBenchmarks>
      ...
      <!--<subSingleStatisticType>PICKED_MOVE_TYPE_BEST_SCORE_DIFF</subSingleStatisticType>-->
      <!--<subSingleStatisticType>PICKED_MOVE_TYPE_STEP_SCORE_DIFF</subSingleStatisticType>-->
    </problemBenchmarks>
