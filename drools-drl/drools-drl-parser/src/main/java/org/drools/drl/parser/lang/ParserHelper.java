...
public class ParserHelper {
    ...
    public static void logHalfConstraintWarn(String logicalConstraint, BaseDescr descr) {
        ...
        if (descr instanceof RelationalExprDescr relational) {
            ...
            LOG.warn("The use of a half constraint '{}' is deprecated and will be removed in the future version (LanguageLevel.DRL10)." +
                             " Please add a left operand.", halfConstraintStr);
            if (logCounterHalfConstraint == 10) {
    ...
    public static void logCustomOperatorWarn(Token token) {
        ...
        LOG.warn("Custom operator will require a prefix '##' in the future version (LanguageLevel.DRL10), so '{}' will be '##{}'." +
                         " This is just for information, not requiring immediate migration.", operator, operator);
    }
