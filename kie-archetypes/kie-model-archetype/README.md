...
mvn archetype:generate 
   ...
   -DarchetypeVersion=8.14.0-SNAPSHOT
```
or use this one-liner

```
mvn archetype:generate -DarchetypeGroupId=org.kie -DarchetypeArtifactId=kie-model-archetype -DarchetypeVersion=8.14.0-SNAPSHOT
```
