...
public class Expr9ViewItemImpl<A, B, C, D, E, F, G, H, I> extends AbstractExprViewItem<A> implements ExprNViewItem<A> {
    ...
    public Expr9ViewItemImpl( Variable<A> var1, Variable<B> var2, Variable<C> var3, Variable<D> var4, Variable<E> var5, Variable<F> var6, Variable<G> var7,
    ...
    public Expr9ViewItemImpl( String exprId, Variable<A> var1, Variable<B> var2, Variable<C> var3, Variable<D> var4, Variable<E> var5, Variable<F> var6, Variable<G> var7,
                              Variable<H> var8, Variable<I> var9,
                              Predicate9<A, B, C, D, E, F, G, H, I> predicate) {
        super(exprId, var1);
        this.var2 = var2;
    ...
    public Predicate9<A, B, C, D, E, F, G, H, I> getPredicate() {
        return predicate;
    }
    ...
    public Variable<?>[] getVariables() {
        return new Variable[]{getFirstVariable(), getVar2(), getVar3(), getVar4(), getVar5(), getVar6(), getVar7(), getVar8(), getVar9()};
    }
