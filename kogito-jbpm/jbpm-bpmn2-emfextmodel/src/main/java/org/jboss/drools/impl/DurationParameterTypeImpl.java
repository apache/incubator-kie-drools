 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.DurationParameterTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DurationParameterTypeImpl extends ConstantParameterImpl implements DurationParameterType {
	...
	public void setValue(Object newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.DURATION_PARAMETER_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.DURATION_PARAMETER_TYPE__VALUE:
				return getValue();
		}
