...
link:https://www.drools.org/[{PRODUCT}] is a set of projects grouped around decision management, containing a forward-chaining and backward-chaining inference-based rules engine, DMN decisions engine and other projects. A rules engine is a fundamental building block to create an expert system which, in artificial intelligence, is a computer system that emulates the decision-making ability of a human expert.
