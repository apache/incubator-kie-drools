...
public class KieFEELExtendedFunctionsTest extends BaseFEELTest {
    ...
    private static Collection<Object[]> data() {
        final Object[][] cases = new Object[][] {
                ...
                { "context merge({name: \"John Doe\"})", mapOf(entry("name", "John Doe")), null },
                { "context merge([{name: \"John Doe\", age: 0}, {age: 47}])", mapOf(entry("name", "John Doe"),entry("age", new BigDecimal(47))), null },
                { "context([{key: null, value: \"John Doe\"},{\"key\": \"age\", \"value\": 47}])", null, FEELEvent.Severity.ERROR },
                { "context([{key: \"name\", value: \"John Doe\"},{\"key\": \"age\", \"value\": null}])", null, FEELEvent.Severity.ERROR },
