...
public class XStreamSolutionFileIOTest {
    ...
    public void readAndWrite() {
        ...
        original.setValueList(Arrays.asList(new XStreamTestdataValue("v1"), new XStreamTestdataValue("v2")));
        original.setEntityList(Arrays.asList(
                new XStreamTestdataEntity("e1"), new XStreamTestdataEntity("e2"), new XStreamTestdataEntity("e3")));
