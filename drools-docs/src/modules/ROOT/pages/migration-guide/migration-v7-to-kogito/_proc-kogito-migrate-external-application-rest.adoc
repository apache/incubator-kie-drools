...
+
For more information about REST endpoints for specific DMN models, see https://blog.kie.org/2021/03/new-model-specific-dmn-kie-server-endpoints.html[_REST endpoints for specific DMN models_].
