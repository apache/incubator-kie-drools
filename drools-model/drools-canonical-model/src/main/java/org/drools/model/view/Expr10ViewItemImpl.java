...
public class Expr10ViewItemImpl<A, B, C, D, E, F, G, H, I, J> extends AbstractExprViewItem<A> implements ExprNViewItem<A> {
    ...
    public Expr10ViewItemImpl( Variable<A> var1, Variable<B> var2, Variable<C> var3, Variable<D> var4, Variable<E> var5, Variable<F> var6, Variable<G> var7,
    ...
    public Expr10ViewItemImpl( String exprId, Variable<A> var1, Variable<B> var2, Variable<C> var3, Variable<D> var4, Variable<E> var5, Variable<F> var6, Variable<G> var7,
                               Variable<H> var8, Variable<I> var9, Variable<J> var10,
                               Predicate10<A, B, C, D, E, F, G, H, I, J> predicate) {
        super(exprId, var1);
        this.var2 = var2;
    ...
    public Predicate10<A, B, C, D, E, F, G, H, I, J> getPredicate() {
        return predicate;
    }
    ...
    public Variable<?>[] getVariables() {
        return new Variable[]{getFirstVariable(), getVar2(), getVar3(), getVar4(), getVar5(), getVar6(), getVar7(), getVar8(), getVar9(), getVar10()};
    }
