...
final class BavetGroupBridge0Mapping3CollectorTriConstraintStream<Solution_, A, B, C, ResultContainerA_, NewA, ResultContainerB_, NewB, ResultContainerC_, NewC>
    ...
    public BavetGroupBridge0Mapping3CollectorTriConstraintStream(BavetConstraintFactory<Solution_> constraintFactory,
    ...
    protected AbstractGroupTriNode<A, B, C, TriTuple<NewA, NewB, NewC>, ?, ?, ?> createNode(int inputStoreIndex,
        ...
        return new Group0Mapping3CollectorTriNode<>(inputStoreIndex,
