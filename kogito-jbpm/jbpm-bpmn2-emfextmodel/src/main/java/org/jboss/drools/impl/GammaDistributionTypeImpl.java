 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.GammaDistributionTypeImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link org.jboss.drools.impl.GammaDistributionTypeImpl#getShape <em>Shape</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GammaDistributionTypeImpl extends DistributionParameterImpl implements GammaDistributionType {
	...
	public void setScale(double newScale) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.GAMMA_DISTRIBUTION_TYPE__SCALE, oldScale, scale, !oldScaleESet));
	}
	...
	public void unsetScale() {
		...
		scaleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.GAMMA_DISTRIBUTION_TYPE__SCALE, oldScale, SCALE_EDEFAULT, oldScaleESet));
	}
	...
	public void setShape(double newShape) {
		...
		shapeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.GAMMA_DISTRIBUTION_TYPE__SHAPE, oldShape, shape, !oldShapeESet));
	}
	...
	public void unsetShape() {
		...
		shapeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.GAMMA_DISTRIBUTION_TYPE__SHAPE, oldShape, SHAPE_EDEFAULT, oldShapeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.GAMMA_DISTRIBUTION_TYPE__SCALE:
				return getScale();
			case DroolsPackage.GAMMA_DISTRIBUTION_TYPE__SHAPE:
				return getShape();
		}
