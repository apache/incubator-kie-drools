...
public class KiePMMLModelRetrieverTest {
    ...
    public void getFromDataDictionaryAndModelWithProvider() throws Exception {
        ...
        final Optional<KiePMMLModel> retrieved = getFromCommonDataAndModel(pmmlModel.getDataDictionary(), getTransformationsMap(pmmlModel.getTransformationDictionary()), pmmlModel.getModels().get(0), null);
