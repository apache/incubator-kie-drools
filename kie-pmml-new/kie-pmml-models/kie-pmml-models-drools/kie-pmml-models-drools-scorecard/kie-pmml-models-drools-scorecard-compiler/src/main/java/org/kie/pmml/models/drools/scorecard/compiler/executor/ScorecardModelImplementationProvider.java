...
public class ScorecardModelImplementationProvider extends DroolsModelProvider<Scorecard ,KiePMMLScorecardModel>{
    ...
    @Override
    public KiePMMLScorecardModel getKiePMMLDroolsModel(DataDictionary dataDictionary, Scorecard model) {
        return KiePMMLScorecardModelFactory.getKiePMMLScorecardModel(dataDictionary, model);
    }
}
