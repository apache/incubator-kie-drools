...
public class LogicalTraitTest extends CommonTraitTest {
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testShadowAlias(VirtualPropertyMode mode) {
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testShadowAliasTraitOnClass(VirtualPropertyMode mode) {
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testShadowAliasClassOnTrait(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; \n" +
                "import org.drools.core.factmodel.traits.*; \n" +
                "import org.drools.core.factmodel.traits.Trait; \n" +
                "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testShadowAliasTraitOnTrait(VirtualPropertyMode mode) {
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void initializationConflictManagement(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; \n" +
                "" +
                "global java.util.List list; \n" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testInitializationConflictManagementPrimitiveTypes(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; \n" +
                "" +
                "global java.util.List list; \n" +
                "global java.util.List list2; \n" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @Tag("ReviseTraitTestWithPRAlwaysCategory")
    @ParameterizedTest
    void testHardGetSetOnLogicallyTraitedField(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; " +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testFieldTypeDonMap(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; \n" +
                "" +
                "global java.util.List list; \n" +
                "global java.util.List list2; \n" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testDataStructs(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; \n" +
                "" +
                "global java.util.List list; \n" +
                "global java.util.List list2; \n" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void shadowAliasSelf(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; \n" +
                "import org.drools.core.factmodel.traits.*; \n" +
                "import org.drools.core.factmodel.traits.Trait; \n" +
                "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void traitOnSet(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; \n" +
                "import org.drools.core.factmodel.traits.*; \n" +
                "import org.drools.core.factmodel.traits.Trait; \n" +
                "" +
...
//        }
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testShadowAliasTraitOnClassLogicalRetract(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; \n" +
                "import org.drools.core.factmodel.traits.*; \n" +
                "import org.drools.core.factmodel.traits.Trait; \n" +
                "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testShadowAliasClassOnTraitLogicalRetract(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; \n" +
                "import org.drools.core.factmodel.traits.*; \n" +
                "import org.drools.core.factmodel.traits.Trait; \n" +
                "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testSerial(VirtualPropertyMode mode) {
        String drl = "package org.drools.test; \n" +
                "import org.drools.core.factmodel.traits.*; \n" +
                "import org.drools.core.factmodel.traits.Trait; \n" +
                "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitMismatchTypes(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitMismatchTypes2(VirtualPropertyMode mode) {
        String drl = "" +
                "package org.drools.core.factmodel.traits.test;\n" +
                "\n" +
                "import org.drools.core.factmodel.traits.Thing;\n" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitMismatchTypes3(VirtualPropertyMode mode) {
        String drl = "" +
                "package org.drools.core.factmodel.traits.test;\n" +
                "\n" +
                "import org.drools.core.factmodel.traits.Traitable;\n" +
