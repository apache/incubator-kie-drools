...
public class DriverTest extends TestCase {
	...
	public void testDriverGenreFactor() throws IOException, Exception {
		...
		assertEquals(1.92, driverMale.getInsuranceFactor());
		...
		assertEquals(1.0, driverFemale.getInsuranceFactor());

	}

	public void testOldDriver() throws IOException, Exception {
		SimpleDateFormat df = new java.text.SimpleDateFormat("dd/MM/yyyy");
		defaultBirthday = df.parse("18/09/1959");

		Driver driverMale = new Driver();
		driverMale.setBirhDate(defaultBirthday);
		driverMale.setPriorClaims(1);
		driverMale.setLicenceYears(30);
		...
		assertEquals(1.0, driverMale.getInsuranceFactor());
	}

	public void testMatureDriverWithChildFactor() throws IOException, Exception {
		...
		assertEquals(1.5, driverMale.getInsuranceFactor());
	...
	public void testDriverUnderAgeRejection() throws ParseException {
		...
		assertEquals(0.0, driver.getInsuranceFactor());
	...
	public void testYoungProblematicDriver() {
		...
		assertEquals(3.84, driverMale.getInsuranceFactor());
	...
	public void testProblematicDriver() throws ParseException {
		...
		assertEquals(2.4, driver.getInsuranceFactor());
