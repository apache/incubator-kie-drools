...
public class DMNStronglyTypedSupportTest extends BaseVariantTest {
    ...
    public void testDateAndTime() {
        ...
        if (isTypeSafe()) {
            ...
            assertThat(allProperties.get("Time")).isEqualTo(FEELZonedTime.of(0, 0, 1, 0, ZoneOffset.ofHours(-1)));
            assertThat(allProperties.get("Date-Time2")).isEqualTo(ZonedDateTime.of(2015, 12, 24, 0, 0, 1, 0, ZoneOffset.ofHours(-1)));
            assertThat(allProperties.get("Time2")).isEqualTo(FEELZonedTime.of(0, 0, 1, 0, ZoneOffset.ofHours(-1)));
            assertThat(allProperties.get("Time3")).isEqualTo(FEELZonedTime.of(12, 59, 1, 300000000, ZoneOffset.ofHours(-1)));
