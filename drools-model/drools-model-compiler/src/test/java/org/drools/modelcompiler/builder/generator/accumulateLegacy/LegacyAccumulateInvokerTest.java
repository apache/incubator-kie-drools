...
public class LegacyAccumulateInvokerTest {
    ...
    public void testInvokerGenerationMultiPattern() throws Exception {
        ...
        final Declaration nameDeclaration = new Declaration("name", store.getReader(Person.class, "name"), null);
        final Declaration ageDeclaration = new Declaration("age", store.getReader(Person.class, "age"), null);
        final Declaration[] declarations = new Declaration[]{nameDeclaration, ageDeclaration};
        ...
        LegacyAccumulateInvoker la = new LegacyAccumulateInvoker(map);

        final CompilationUnit build = la.build();

        assertEquals(multiPatternResultParsed.toString(), build.toString());
    }
