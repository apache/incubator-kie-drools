...
public class CounterfactualExplainabilityResultMarshallerTest extends MarshallerTestTemplate<CounterfactualExplainabilityResult> {
    ...
    private static final List<AbstractTestField<CounterfactualExplainabilityResult, ?>> TEST_FIELD_LIST = List.of(
            new StringTestField<>(EXECUTION_ID_FIELD, "executionId", CounterfactualExplainabilityResult::getExecutionId, CounterfactualExplainabilityResult::setExecutionId),
            ...
            new StringTestField<>(STATUS_DETAILS_FIELD, "explanation", CounterfactualExplainabilityResult::getStatusDetails, CounterfactualExplainabilityResult::setStatusDetails),
            new StringTestField<>(COUNTERFACTUAL_ID_FIELD, "counterfactualId", CounterfactualExplainabilityResult::getCounterfactualId, CounterfactualExplainabilityResult::setCounterfactualId),
            new StringTestField<>(COUNTERFACTUAL_SOLUTION_ID_FIELD, "solutionId", CounterfactualExplainabilityResult::getSolutionId, CounterfactualExplainabilityResult::setSolutionId));
