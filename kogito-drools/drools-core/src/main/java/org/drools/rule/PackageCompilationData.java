...
public class PackageCompilationData
    ...
    public void write(final String resourceName,
                      final byte[] clazzData) throws CheckedDroolsException {
    ...
    public void remove(final String resourceName) throws CheckedDroolsException {
     ...
     */
    public void reload() throws CheckedDroolsException {
