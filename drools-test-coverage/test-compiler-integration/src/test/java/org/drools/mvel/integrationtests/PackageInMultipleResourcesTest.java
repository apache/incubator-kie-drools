...
public class PackageInMultipleResourcesTest {
    ...
    public void testSamePackageRulesInDRLAndRF(KieBaseTestConfiguration kieBaseTestConfiguration) {
        // DROOLS-6785
    ...
    @ParameterizedTest(name = "KieBase type={0}")
    @MethodSource("parameters")
    public void testDifferentPackagesRulesInDRLAndRF(KieBaseTestConfiguration kieBaseTestConfiguration) {
        // DROOLS-6797
