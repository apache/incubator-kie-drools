...
public class DrlCompilationContextImpl extends EfestoCompilationContextImpl implements DrlCompilationContext {
    ...
    protected DrlCompilationContextImpl(EfestoCompilationContextImpl efestoCompilationContext) {
        super(efestoCompilationContext);
    }

    public DrlCompilationContextImpl(MemoryCompilerClassLoader memoryCompilerClassLoader) {
