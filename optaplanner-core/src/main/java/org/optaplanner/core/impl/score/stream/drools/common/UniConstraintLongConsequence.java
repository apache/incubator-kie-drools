...
final class UniConstraintLongConsequence<A>
        extends AbstractUniConstraintConsequence<A>
        implements Supplier<ToLongFunction<A>> {

    private final UniLeftHandSide<A> leftHandSide;
    private final ToLongFunction<A> matchWeighter;

    UniConstraintLongConsequence(UniLeftHandSide<A> leftHandSide, ToLongFunction<A> matchWeighter) {
