...
public class BindViewItem3<T> implements ViewItem<T>,
                                         Binding,
                                         ModelComponent {

    private final Variable<T> boundVariable;
    private final Function3 bindingFunction;
    ...
    public BindViewItem3(Variable<T> boundVariable, Function3 bindingFunction, Variable inputVariable1, Variable inputVariable2, Variable inputVariable3, String[] reactOn, String[] watchedProps) {
    ...
    public Object eval(Object... args) {
        return bindingFunction.apply(args[0], args[1], args[2]);
    }
    ...
    public boolean isEqualTo(ModelComponent o) {
        ...
        if (!(o instanceof BindViewItem3)) {
            return false;
        }

        BindViewItem3<?> that = (BindViewItem3<?>) o;
