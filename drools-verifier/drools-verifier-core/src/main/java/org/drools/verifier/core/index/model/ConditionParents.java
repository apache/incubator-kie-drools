 ...
 * Fields for DRL.
 */
public class ConditionParents
        extends FieldsBase<ConditionParent> {

    private AnalyzerConfiguration configuration;

    public ConditionParents(final AnalyzerConfiguration configuration) {
    ...
    public class FieldSelector
            extends Select<ConditionParent> {
        ...
        public Conditions conditions() {
            final Conditions conditions = new Conditions(configuration.getConditionKeyDefinitions());

            final MultiMap<Value, ConditionParent, List<ConditionParent>> subMap = asMap();
            if (subMap != null) {
                final Collection<ConditionParent> fields = subMap.allValues();
        ...
        public Actions actions() {
            final Actions actions = new Actions(configuration.getActionKeyDefinitions());
    ...
    public class FieldListen
            extends Listen<ConditionParent> {
