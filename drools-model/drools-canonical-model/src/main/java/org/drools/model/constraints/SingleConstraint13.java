...
public class SingleConstraint13<A, B, C, D, E, F, G, H, I, J, K, L, M> extends AbstractSingleConstraint {
    ...
    public Variable[] getVariables() {
        return new Variable[]{var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13};
    }

    @Override
    public PredicateN getPredicate() {
        return objs -> {
            return predicate.test((A) objs[0], (B) objs[1], (C) objs[2], (D) objs[3], (E) objs[4], (F) objs[5], (G) objs[6], (H) objs[7], (I) objs[8], (J) objs[9], (K) objs[10], (L) objs[11], (M) objs[12]);
        };
    }
    ...
    public boolean isEqualTo( ModelComponent o ) {
        ...
        SingleConstraint13<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> that = ( SingleConstraint13<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> ) o;
