...
public class ValidatorArtifactModelTest {
    ...
    public void testASSOC_REFERENCES_NOT_EMPTY() {
        List<DMNMessage> validate = validator.validate( getReader( "artifactmodel/ASSOC_REFERENCES_NOT_EMPTY.dmn" ), VALIDATE_SCHEMA, VALIDATE_MODEL, VALIDATE_COMPILATION);
