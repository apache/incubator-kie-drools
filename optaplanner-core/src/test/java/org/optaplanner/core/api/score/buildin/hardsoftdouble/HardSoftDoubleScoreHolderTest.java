...
public class HardSoftDoubleScoreHolderTest extends AbstractScoreHolderTest {
    ...
    public void addConstraintMatch(boolean constraintMatchEnabled) {
        ...
        scoreHolder.addHardConstraintMatch(ruleContext3, -3.00); // Rule of different level added
        scoreHolder.addHardConstraintMatch(ruleContext3, -4.00); // Rule of different level modified
        ...
        assertEquals(HardSoftDoubleScore.valueOf(-15.00, -0.06), scoreHolder.extractScore());
