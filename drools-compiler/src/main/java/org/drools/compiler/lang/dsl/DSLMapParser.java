// $ANTLR 3.5 src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g 2015-05-07 18:09:39
...
public class DSLMapParser extends Parser {
	...
	public final DSLMapParser.entry_return entry() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: scope_section, meta_section, key_section, value_section
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final DSLMapParser.variable_definition_return variable_definition() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: q, q, name, name, q, name, name, q, q, q, q, name, q, name, name, name, name, q
			// token labels: q, name
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
