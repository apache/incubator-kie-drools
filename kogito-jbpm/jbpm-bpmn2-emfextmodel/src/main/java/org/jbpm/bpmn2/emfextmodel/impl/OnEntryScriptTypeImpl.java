 ...
 * <ul>
 *   <li>{@link org.jbpm.bpmn2.emfextmodel.impl.OnEntryScriptTypeImpl#getScript <em>Script</em>}</li>
 *   <li>{@link org.jbpm.bpmn2.emfextmodel.impl.OnEntryScriptTypeImpl#getScriptFormat <em>Script Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OnEntryScriptTypeImpl extends EObjectImpl implements OnEntryScriptType {
    ...
    protected EClass eStaticClass() {
        return EmfextmodelPackage.Literals.ON_ENTRY_SCRIPT_TYPE;
    }
    ...
    public void setScript(String newScript) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EmfextmodelPackage.ON_ENTRY_SCRIPT_TYPE__SCRIPT, oldScript, script));
    }
    ...
    public void setScriptFormat(String newScriptFormat) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EmfextmodelPackage.ON_ENTRY_SCRIPT_TYPE__SCRIPT_FORMAT, oldScriptFormat, scriptFormat));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case EmfextmodelPackage.ON_ENTRY_SCRIPT_TYPE__SCRIPT:
                return getScript();
            case EmfextmodelPackage.ON_ENTRY_SCRIPT_TYPE__SCRIPT_FORMAT:
