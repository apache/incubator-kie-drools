...
public class FeelCtx {
    ...
    public static MethodCallExpr getValue(String nameRef) {
        return new MethodCallExpr(compiledFeelSemanticMappingsFQN(), "getValue", new NodeList<>(FEELCTX_N,
                                                                                                new StringLiteralExpr(nameRef)));
    }

    public static MethodCallExpr current() {
        return new MethodCallExpr(FEELCTX_N, "current");
    }
