...
public class StatelessKnowledgeSessionImpl extends AbstractRuntime
    ...
    private final List<ListnerHolder> listners = new CopyOnWriteArrayList<ListnerHolder>();
    ...
    private void registerListeners( StatefulKnowledgeSessionImpl wm ) {
        ...
        for (ListnerHolder listnerHolder : listners) {
    ...
    public void addEventListener(AgendaEventListener listener) {
        listners.add(new ListnerHolder( ListnerHolder.Type.AGENDA, listener ));
    }
    ...
    public void removeEventListener(AgendaEventListener listener) {
        listners.remove(new ListnerHolder( ListnerHolder.Type.AGENDA, listener ));
    }

    public void addEventListener(RuleRuntimeEventListener listener) {
        listners.add(new ListnerHolder( ListnerHolder.Type.RUNTIME, listener ));
    }

    public void removeEventListener(RuleRuntimeEventListener listener) {
        listners.remove(new ListnerHolder( ListnerHolder.Type.RUNTIME, listener ));
    }
    ...
    public void addEventListener(ProcessEventListener listener) {
        listners.add(new ListnerHolder( ListnerHolder.Type.PROCESS, listener ));
    }
    ...
    private static class ListnerHolder {
        ...
        public boolean equals( Object obj ) {
            ...
            return type == that.type && listener.equals( that.listener );
        }
