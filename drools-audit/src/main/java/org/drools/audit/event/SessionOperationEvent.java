 ...
 */
public class SessionOperationEvent extends AuditEvent {

    private static final long serialVersionUID = 1L;

    private final int rulesFiredCount;
    private final long durationMillis;

    public SessionOperationEvent(AuditEventType type,
                                 String sessionId,
                                 long sequenceNumber,
                                 int rulesFiredCount,
                                 long durationMillis) {
