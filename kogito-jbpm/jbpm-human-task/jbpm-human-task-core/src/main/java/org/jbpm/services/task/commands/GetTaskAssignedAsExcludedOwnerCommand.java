...
public class GetTaskAssignedAsExcludedOwnerCommand extends UserGroupCallbackTaskCommand<List<TaskSummary>> {
	...
	public GetTaskAssignedAsExcludedOwnerCommand(String userId, String language) {
		this.userId = userId;
    ...
    public List<TaskSummary> execute(Context cntxt) {
    	...
    	return context.getTaskQueryService().getTasksAssignedAsExcludedOwner(userId, language);
