...
import static org.drools.modelcompiler.util.ClassUtil.getAccessiblePropertiesIncludingPrimitiveWrapper;
...
public class PackageModel {
    ...
    public String getDomainClassesMetadataSource() {
        ...
        for (Class<?> domainClass : domainClasses) {
            ...
            List<String> accessibleProperties = getAccessiblePropertiesIncludingPrimitiveWrapper( domainClass );
