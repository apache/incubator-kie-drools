...
public final class BytePropertySetterFactory extends PropertySetterFactory<ObjectByteConsumer> {
    ...
    protected BytePropertySetterFactory(Method setterMethod,
                                        Class<?> propertyType,
    ...
    @Override
    protected ObjectByteConsumer functionFromCallSite(CallSite setterSite) throws Throwable {
        return (ObjectByteConsumer) setterSite.getTarget().invokeExact();
    }
    ...
    protected class ByteUnboxingSetterFunction implements BiConsumer<Object, Object> {
        ...
        public void accept(Object bean, Object value) {
            setterFunction.accept(bean, (byte) value);
        }
    }
}
