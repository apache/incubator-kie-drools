...
public class ObjectEqualConstrLeftMemoryTest extends BaseBetaLeftMemoryTestClass {
    ...
    protected void setUp() throws Exception {
        ...
        this.memory = new ObjectEqualConstrLeftMemory(
                                extractor,
                                declaration,
                                evaluator);
    }
    ...
    public void testModifyObjectAttribute() {
        ...
        Assert.assertTrue("Memory is leaking object references", ((ObjectEqualConstrLeftMemory)this.memory).isClean());
    }
