...
import static org.drools.modelcompiler.util.ClassUtil.isReadableProperties;
...
public abstract class AbstractExpressionBuilder {
    ...
    String getIndexIdArgument(SingleDrlxParseSuccess drlxParseResult, TypedExpression left) {
        return isReadableProperties( drlxParseResult.getPatternType(), left.getFieldName() ) ?
