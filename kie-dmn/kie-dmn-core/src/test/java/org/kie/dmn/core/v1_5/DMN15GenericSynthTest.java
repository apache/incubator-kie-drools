...
public class DMN15GenericSynthTest extends BaseVariantTest {

    public static final Logger LOG = LoggerFactory.getLogger(DMN15GenericSynthTest.class);
    ...
    public void filterDatatype(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void filterDatatype2(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void iteratorDatatype(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void iteratorDatatype2(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
