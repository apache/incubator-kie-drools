...
A Spring Boot starter is an all-in-one descriptor for your project and requires business automation engines provided by {KOGITO}. The Spring Boot starters include decisions, rules, processes, and predictions.
...
$ mvn archetype:generate \
    ...
    -Dstarters=processes
----
The new project includes the dependencies required to run the process microservices. You can combine multiple Spring Boot starters using a comma-separated list, such as `starters=processes,rules`.
--
