...
public class AllFunctionTest {
    ...
    public void invokeBooleanParamNull() {
        FunctionTestUtil.assertResult(allFunction.invoke((Boolean) null), true);
    }
    ...
    public void invokeArrayParamNull() {
        FunctionTestUtil.assertResult(allFunction.invoke((Object[]) null), true);
    }
    ...
    public void invokeArrayParamReturnNull() {
        FunctionTestUtil.assertResult(allFunction.invoke(new Object[]{Boolean.TRUE, null, Boolean.TRUE}), true);
    }
    ...
    public void invokeListParamNull() {
        FunctionTestUtil.assertResult(allFunction.invoke((List) null), true);
    }
    ...
    public void invokeListParamReturnNull() {
        FunctionTestUtil.assertResult(allFunction.invoke(Arrays.asList(Boolean.TRUE, null, Boolean.TRUE)), true);
    }
