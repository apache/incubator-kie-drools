...
public class ClassUtil {
    ...
    // ACCESSIBLE_PROPS_CACHE_INCLUDING_NON_GETTER must contain the same order of props in PropertyReactivityUtil.getAccessibleProperties() first. Then NON_GETTER methods are listed at the end.
