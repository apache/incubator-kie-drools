...
<plannerBenchmark>
  ...
  <inheritedSolverBenchmark>
    <problemBenchmarks>
      ...
      <!--<subSingleStatisticType>CONSTRAINT_MATCH_TOTAL_BEST_SCORE</subSingleStatisticType>-->
      <!--<subSingleStatisticType>CONSTRAINT_MATCH_TOTAL_STEP_SCORE</subSingleStatisticType>-->
