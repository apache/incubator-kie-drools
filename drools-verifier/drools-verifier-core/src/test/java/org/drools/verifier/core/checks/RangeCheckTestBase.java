...
public abstract class RangeCheckTestBase {
    ...
    public void setUp() throws Exception {
        index = new IndexImpl(analyzerConfiguration);

        ageConditionColumn = new Column(1, ColumnType.LHS, analyzerConfiguration);
        animalTypeConditionColumn = new Column(2, ColumnType.LHS, analyzerConfiguration);
        actionColumn = new Column(3, ColumnType.RHS, analyzerConfiguration);
    ...
    protected void addRow(final int rowNumber,
        ...
        typePattern.getConditionParents().add(ageField);
        typePattern.getConditionParents().add(kittenField);
        typePattern.getConditionParents().add(riskField);
