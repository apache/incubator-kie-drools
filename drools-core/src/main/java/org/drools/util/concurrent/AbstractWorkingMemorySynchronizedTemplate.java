 ...
 * to define their own strategy for obtaining the WorkingMemory instance.
 */
public abstract class AbstractWorkingMemorySynchronizedTemplate
    ...
    /**
     * Concrete subclasses must implement this method to provide the
    ...
    /**
     * Invokes the callback within a synchronized block on the workingMemory
