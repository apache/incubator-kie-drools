// $ANTLR 3.5 src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g 2013-08-12 14:28:29
...
public class DSLMapParser extends Parser {
	...
	public final DSLMapParser.variable_definition_return variable_definition() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: q, name, name, name, q, q, name, name, name, q, q, q, name, name, q, q, q, name
			// token labels: q, name
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public static final BitSet FOLLOW_LEFT_CURLY_in_variable_reference1359 = new BitSet(new long[]{0x0000000000002000L});
	public static final BitSet FOLLOW_LITERAL_in_variable_reference1377 = new BitSet(new long[]{0x0000000000008000L});
