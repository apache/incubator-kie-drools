...
public class EqualityComparisonNullCheckTest extends BaseOperatorsTest {
    ...
    public void operatorsWithNull() throws Exception {
        ...
        String drl = "import " + type.getCanonicalName() + ";\n" +
                     ...
                     "when\n";
        if (propertyOnLeft) {
            drl += "  ValueHolder(" + propertyName + " " + operator + " null)\n";
        } else {
            drl += "  ValueHolder(null " + operator + " " + propertyName + ")\n";
        }
        drl += "then\n" +
               "end\n";
        ...
        try {
            ...
            if (operator.equals("==") && fired == 1 || operator.equals("!=") && fired == 0) {
                assertTrue(true);
            } else {
                fail("Wrong result");
            }
