...
import org.kie.dmn.backend.marshalling.v1_1.xstream.extensions.TestCasesExtensionRegister;
...
public final class ExtendedDMNProfile extends KieExtendedFEELProfile implements DMNProfile {
    ...
    private static final List<DMNExtensionRegister> EXTENSION_REGISTERS = Arrays.asList(new DecisionServicesExtensionRegister(), new TestCasesExtensionRegister());
