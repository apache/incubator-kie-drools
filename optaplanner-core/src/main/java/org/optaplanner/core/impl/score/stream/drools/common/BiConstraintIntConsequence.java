...
final class BiConstraintIntConsequence<A, B>
        extends AbstractBiConstraintConsequence<A, B>
        implements Supplier<ToIntBiFunction<A, B>> {

    private final BiLeftHandSide<A, B> leftHandSide;
    private final ToIntBiFunction<A, B> matchWeighter;

    BiConstraintIntConsequence(BiLeftHandSide<A, B> leftHandSide, ToIntBiFunction<A, B> matchWeighter) {
