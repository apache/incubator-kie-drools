...
public final class BavetScoringTriConstraintStream<Solution_, A, B, C> extends BavetAbstractTriConstraintStream<Solution_, A, B, C> {
    ...
    public BavetScoringTriConstraintStream(BavetConstraint<Solution_> bavetConstraint, boolean positive) {
        this(bavetConstraint, positive, true, null, null, null);
    }

    public BavetScoringTriConstraintStream(BavetConstraint<Solution_> bavetConstraint, boolean positive, ToIntTriFunction<A, B, C> intMatchWeigher) {
    ...
    public BavetScoringTriConstraintStream(BavetConstraint<Solution_> bavetConstraint, boolean positive, ToLongTriFunction<A, B, C> longMatchWeigher) {
    ...
    public BavetScoringTriConstraintStream(BavetConstraint<Solution_> bavetConstraint, boolean positive, TriFunction<A, B, C, BigDecimal> bigDecimalMatchWeigher) {
    ...
    private BavetScoringTriConstraintStream(BavetConstraint<Solution_> bavetConstraint,
