...
public class ForIterationUtils {
    ...
    public static ForIteration getForIteration(EvaluationContext ctx, String name, Object start, Object end) {
        ...
        if (start instanceof BigDecimal strt) {
            return new ForIteration(name, strt, (BigDecimal) end);
        }
        if (start instanceof LocalDate strt) {
            return new ForIteration(name, strt, (LocalDate) end);
        }
