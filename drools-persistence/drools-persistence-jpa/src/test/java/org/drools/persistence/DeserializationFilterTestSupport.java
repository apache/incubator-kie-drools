...
public class DeserializationFilterTestSupport {
    ...
    public void setUp(String... patterns) {
        savedAllowedPatterns = System.getProperty(KeyStoreConstants.PROP_ALLOWED_DESER_CLASS_PATTERNS);
    ...
    public void tearDown() {
        if (savedAllowedPatterns != null) {
            System.setProperty(KeyStoreConstants.PROP_ALLOWED_DESER_CLASS_PATTERNS, savedAllowedPatterns);
        } else {
