...
public class DMN15ExpressionsTest extends BaseVariantTest {

    public static final Logger LOG = LoggerFactory.getLogger(DMN15ExpressionsTest.class);
    ...
    void setup() {
        runtime = createRuntime("dmn15expressions.dmn", DMN15ExpressionsTest.class);
    ...
    public void conditionalWithInput(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
        setup();
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void conditionalNonBooleanIf(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
        setup();
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void iteratorFor(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
        setup();
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void iteratorForPartial(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
        setup();
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void iteratorForInRangeClose(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
        setup();
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void iteratorForInRangeOpen(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
        setup();
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void iteratorSome(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
        setup();
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void iteratorEvery(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
        setup();
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void filterIndex(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
        setup();
    ...
    @MethodSource("params")
    @ParameterizedTest(name = "{0}")
    public void filterExpression(final VariantTestConf conf) throws Throwable {
        testConfig = conf;
        setup();
