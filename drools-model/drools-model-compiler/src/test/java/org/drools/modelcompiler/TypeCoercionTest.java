...
public class TypeCoercionTest extends BaseModelTest {
    ...
    public void testEqualCoercion() {
        withRule("import " + Person.class.getCanonicalName(),
        ...
        withFacts(new Person("40"));
        whenWeFireAllRules();
        resultContainsInAnyOrder("40");
    }
    ...
    public void testComparisonCoercion2() {
    	withRule("import " + Person.class.getCanonicalName(),
                ...
                "end");
    	withSessionAndGlobals();
        withFacts(new Person("Mario"));
        whenWeFireAllRules();
        resultContainsInAnyOrder("Mario");
    }
    ...
    public void testDoubleToInt() {
        withRule("import " + DoubleHolder.class.getCanonicalName(),
                "rule R",
                "when",
    ...
    public void testLongToInt() {
        withRule("import " + LongHolder.class.getCanonicalName(),
                "rule R",
                "when",
                "    LongHolder( value == 80 )",
                "then",
    ...
    public void testJoinLongToDouble() {
    	withRule("import " + DoubleHolder.class.getCanonicalName(),
                ...
                "end");
        withStandardSession();
        withFacts(new LongHolder(), new DoubleHolder());
        whenWeFireAllRules();
        firedRulesAre(1);
    }
    ...
    public void testStringToIntCoercion() {
        // DROOLS-5939
    	withRule("import " + ClassWithIntProperty.class.getCanonicalName() + ";",
                ...
                "end");
    	withStandardSession();
    	withFacts(new ClassWithIntProperty( 10 ), new ClassWithStringProperty( "10" ));
    	whenWeFireAllRules();
    	firedRulesAre(1);
    }
