...
** Start with the longest working employee first, then the second longest working employee and so forth, to create <<fairnessScoreConstraints,fairness and load balancing>>.
