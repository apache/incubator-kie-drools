...
public class KieRepositoryScannerNexusTest extends AbstractKieCiTest {
    ...
    public void setUp() throws Exception {
        System.setProperty("kie.maven.settings.custom", new File("target/test-classes/org/kie/scanner/embedder/settings_nexus.xml").getAbsolutePath());
    ...
    public void testKScannerNewContainer() throws Exception {
        ...
        //repository.installArtifact(releaseId, kJar1, createKPomWithDistributionManagement(fileManager, releaseId));
