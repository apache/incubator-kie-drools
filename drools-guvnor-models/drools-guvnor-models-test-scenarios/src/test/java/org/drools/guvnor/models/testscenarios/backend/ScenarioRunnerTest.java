...
public class ScenarioRunnerTest extends RuleUnit {
    ...
    public void testVerifyFacts() throws Exception {
        ...
        scenario.getImports().addImport(new Import("org.drools.guvnor.models.testscenarios.backend.Cheese"));
        scenario.getImports().addImport(new Import("org.drools.guvnor.models.testscenarios.backend.Person"));
    ...
    public void testVerifyFactsWithEnum() throws Exception {
        ...
        Scenario scenario = new Scenario();
        scenario.getImports().addImport(new Import("org.drools.guvnor.models.testscenarios.backend.Cheese"));
        scenario.getImports().addImport(new Import("org.drools.guvnor.models.testscenarios.backend.CheeseType"));
    ...
    public void testCollection() throws Exception {
        ...
        Scenario scenario = new Scenario();
        scenario.getImports().addImport(new Import("org.drools.guvnor.models.testscenarios.backend.Cheese"));
        scenario.getImports().addImport(new Import("org.drools.guvnor.models.testscenarios.backend.Cheesery"));
