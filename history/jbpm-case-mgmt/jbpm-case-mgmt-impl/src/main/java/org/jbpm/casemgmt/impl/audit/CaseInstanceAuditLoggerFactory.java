...
public class CaseInstanceAuditLoggerFactory {
     ...
     * @param transactionalCommandService command service to be used
     * @return new instance of JPA case instance audit logger
     */
     ...
     * @return new instance of JMS case instance audit logger
     */
