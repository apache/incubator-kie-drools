// $ANTLR 3.3 Nov 30, 2010 12:46:29 src/main/resources/org/drools/lang/dsl/DSLMap.g 2013-06-09 10:36:22
...
public class DSLMapParser extends Parser {
    ...
    public final DSLMapParser.scope_section_return scope_section() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: value3, value4, value2, value1
            // token labels: 
    ...
    public final DSLMapParser.variable_definition_return variable_definition() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: name, name, name, q, q, name, q, q, name, q, q, name, name, q, q, name, name, q
            // token labels: q, name
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
