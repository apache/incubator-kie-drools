// $ANTLR 3.3 Nov 30, 2010 12:46:29 src/main/resources/org/drools/lang/dsl/DSLMap.g 2012-07-04 10:23:07
...
public class DSLMapParser extends Parser {
    ...
    public final DSLMapParser.variable_definition_return variable_definition() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: q, name, q, name, q, name, q, q, q, q, name, q, name, q, name, name, name, name
            // token labels: q, name
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
