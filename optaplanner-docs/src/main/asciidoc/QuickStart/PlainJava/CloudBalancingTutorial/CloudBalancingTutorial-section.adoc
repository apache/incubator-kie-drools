...
image::QuickStart/PlainJava/CloudBalancingTutorial/cloudBalanceUseCase.png[align="center"]
...
image::QuickStart/PlainJava/CloudBalancingTutorial/cloudOptimizationValueProposition.png[align="center"]
