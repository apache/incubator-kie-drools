...
public class PhreakLiaNodeTest {
    ...
    public void test() {
        ...
        InternalFactHandle fhB = ( InternalFactHandle ) ksession.insert( b( 1 ) );
        
        InternalFactHandle fhA = ( InternalFactHandle ) ksession.insert( a( 1 ) );
...
//
        ...
        InternalFactHandle fhB2 = ( InternalFactHandle ) ksession.insert( b( 2 ) );
        InternalFactHandle fhB3 = ( InternalFactHandle ) ksession.insert( b( 3 ) );
