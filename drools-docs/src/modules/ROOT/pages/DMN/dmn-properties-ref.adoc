...
You can configure some of these properties using the `kmodule.xml` file in your {PRODUCT} project when you deploy your project on {KIE_SERVER}.
...
+
--
To configure this property when deploying your project on {KIE_SERVER}, modify this property in the `kmodule.xml` file of your project. This approach is helpful when the listener is specific to your project and when the configuration must be applied in {KIE_SERVER} only to your deployed project.
...
To configure this property globally for your {PRODUCT} environment, modify this property using a command terminal or any other global application configuration mechanism. This approach is helpful when the {DECISION_ENGINE} is embedded as part of your Java application.
