...
public class BasicAuthenticationFilterProvider implements AuthenticationFilterProvider<BasicAuthenticationCredentials> {
    ...
    public BasicAuthenticationFilterProvider() {
        //CDI proxying
    }
    ...
    @Override
    public AuthenticationFilter createInstance(BasicAuthenticationCredentials credentials) {
        return new BasicAuthenticationFilter(credentials);
    }
}
