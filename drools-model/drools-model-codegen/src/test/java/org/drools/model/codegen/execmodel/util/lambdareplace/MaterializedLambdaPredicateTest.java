...
public class MaterializedLambdaPredicateTest {
    ...
    public void createClassWithOneParameter() {
        ...
        String expectedResult = "" +
                ...
                "public enum CLASS_TOREPLACE implements org.drools.model.functions.Predicate1<org.drools.model.codegen.execmodel.domain.Person>, org.drools.model.functions.HashedExpression {\n" +
                " INSTANCE; \n" +
    ...
    public void createClassWithTwoParameters() {
        ...
        //language=JAVA
        String expectedResult = "" +
                "package org.drools.model.codegen.execmodel.util.lambdareplace.PB4;\n" +
                "import static rulename.*; " +
                "" +
                "" +
                "@org.drools.compiler.kie.builder.MaterializedLambda() " +
                "public enum LambdaPredicateB43A7DAEE6E92A2B4A203826B1336F22 implements org.drools.model.functions.Predicate2<org.drools.model.codegen.execmodel.domain.Person, org.drools.model.codegen.execmodel.domain.Person>, org.drools.model.functions.HashedExpression  {\n" +
                " INSTANCE; \n" +
