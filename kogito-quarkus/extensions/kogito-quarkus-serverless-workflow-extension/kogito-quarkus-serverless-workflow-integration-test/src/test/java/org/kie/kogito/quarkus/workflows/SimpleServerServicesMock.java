...
public class SimpleServerServicesMock implements QuarkusTestResourceLifecycleManager {
    private static final String BEARER = "Bearer ";

    public static final String SIMPLE_SERVER_SERVICE_MOCK_URL = "simple-server-service-mock.url";
    ...
    public Map<String, String> start() {
        ...
        return Collections.singletonMap(SIMPLE_SERVER_SERVICE_MOCK_URL, wireMockServer.baseUrl());
    }
