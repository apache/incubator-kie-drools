...
public class InfixExecutorUtils {
    ...
    /**
     * Common method to manage Invalid Parameters Its behaviour depends on the kind of FEEL syntax used (S-FEEL vs
     * B-FEEL)
     * 
     * @param ctx
     */
    ...
    public static Object getTemporalAmount(Object object, EvaluationContext ctx) {
        if (ctx.getFEELDialect().equals(FEELDialect.BFEEL) && !(object instanceof TemporalAmount)) {
    ...
    public static Object math(Object left, Object right, EvaluationContext ctx, BinaryOperator<BigDecimal> op) {
        ...
        try {
            ...
            ctx.notifyEvt(() -> new InvalidParametersEvent(FEELEvent.Severity.ERROR,
     ...
     */
    static boolean isAllowedMultiplicationBasedOnSpec(final Object left, final Object right,
            final EvaluationContext ctx) {
        if (left instanceof TemporalAmount && right instanceof TemporalAmount) {
            ctx.notifyEvt(() -> new InvalidParametersEvent(FEELEvent.Severity.ERROR,
                    Msg.createMessage(Msg.INVALID_PARAMETERS_FOR_OPERATION, "multiplication", left.getClass().getName(),
     ...
     *         - Subtraction of a datetime with timezone and a datetime without a timezone is not defined in the
     *         specification. - Subtraction of a time and a datetime is not defined in the specification.
     */
    static boolean isAllowedTemporalSubtractionBasedOnSpec(final Temporal leftTemporal, final Temporal rightTemporal,
            final EvaluationContext ctx) {
        ...
        if ((leftTemporal instanceof ZonedDateTime || leftTemporal instanceof FormattedZonedDateTime || leftTemporal instanceof OffsetDateTime)
            ...
            return false;
        } else if ((rightTemporal instanceof ZonedDateTime || rightTemporal instanceof FormattedZonedDateTime || rightTemporal instanceof OffsetDateTime)
