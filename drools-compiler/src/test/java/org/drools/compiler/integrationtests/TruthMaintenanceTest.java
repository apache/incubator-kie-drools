...
public class TruthMaintenanceTest extends CommonTestMethodBase {
    ...
    public void testStatedShadowLogicalThenLogicalOnly() {
        ...
        ((StatefulKnowledgeSessionImpl)session).delete( fh1, InsertionState.STATED );
        session.insert( "go2" );
        session.fireAllRules();
    ...
    public void testStatedDeleteLogicalAssertion() {
        ...
        for (FactHandle fh : fhs) {
            ((StatefulKnowledgeSessionImpl)ksession).delete( fh, InsertionState.STATED );
        }
        ...
        for (FactHandle fh : fhs) {
            ((StatefulKnowledgeSessionImpl)ksession).delete( fh, InsertionState.LOGICAL );
        }
    ...
    public void testStatedDeleteLogicalAssertionFromRule() {
        ...
        String drl =
                ...
                "then\n" +
                "    list.add( $s ); \n" +
                "    delete( $s, org.drools.core.common.InsertionState.STATED ); \n" +
                "end\n";
