...
public class DifferentGenderSwapMoveFilter implements SelectionFilter<Manners2009, GenericSwapMove> {

    public boolean accept(Manners2009 solution, GenericSwapMove move) {
