 ...
 * <ul>
 *   <li>{@link org.jboss.drools.impl.NegativeExponentialDistributionTypeImpl#getMean <em>Mean</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NegativeExponentialDistributionTypeImpl extends DistributionParameterImpl implements NegativeExponentialDistributionType {
	...
	protected EClass eStaticClass() {
		return DroolsPackage.Literals.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE;
	}
	...
	public void setMean(double newMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroolsPackage.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DroolsPackage.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DroolsPackage.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE__MEAN:
				return getMean();
		}
