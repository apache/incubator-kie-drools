...
public class ConstraintEvaluator {
    ...
    static abstract class InnerEvaluator {
        ...
        public abstract boolean evaluate( InternalFactHandle handle, ValueResolver reteEvaluator ) throws Exception;
        public abstract boolean evaluate(InternalFactHandle handle, BaseTuple tuple, ValueResolver reteEvaluator) throws Exception;

        protected Object getArgument( InternalFactHandle handle, ValueResolver reteEvaluator, Declaration declaration, BaseTuple tuple ) {
        ...
        static class _1 extends InnerEvaluator {
            ...
            @Override
            public boolean evaluate( InternalFactHandle handle, ValueResolver reteEvaluator ) throws Exception {
                return predicate.test( declaration.getValue( reteEvaluator, handle ) );
            }

            @Override
            public boolean evaluate( InternalFactHandle handle, BaseTuple tuple, ValueResolver reteEvaluator ) throws Exception {
        ...
        static class _N extends InnerEvaluator {
            ...
            private Object[] getInvocationArgs( InternalFactHandle handle, BaseTuple tuple, ValueResolver reteEvaluator ) {
