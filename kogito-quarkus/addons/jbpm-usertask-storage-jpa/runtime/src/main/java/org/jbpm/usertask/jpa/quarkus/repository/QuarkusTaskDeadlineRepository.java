...
@ApplicationScoped
public class QuarkusTaskDeadlineRepository extends TaskDeadlineRepository {

    QuarkusTaskDeadlineRepository() {
        super(null);
    }

    @Inject
    public QuarkusTaskDeadlineRepository(UserTaskJPAContext context) {
        super(context);
    }
