...
@ApplicationScoped
public class IndexesSqlBuilderImpl implements IndexesSqlBuilder<JsonType, PostgresField, PostgresPartitionField, PostgresMapping, PostgresContext> {

    private static final Logger LOGGER = LoggerFactory.getLogger(IndexesSqlBuilderImpl.class);
