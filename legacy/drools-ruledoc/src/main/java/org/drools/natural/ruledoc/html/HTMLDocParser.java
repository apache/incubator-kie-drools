 ...
 * 
 * Uses the most excellent www.htmlparser.org parser. Nicely done.
 * 
...
public class HTMLDocParser 
{
    ...
    private void handleTag(TagNode tag)
    {
        ...
        if (tagName.equals("I")) {
            ...
            //Hmm... should I check for closing? may 
            //end up with doubles otherwise, not really a problem I guess.
            listener.handleText("\n");            
