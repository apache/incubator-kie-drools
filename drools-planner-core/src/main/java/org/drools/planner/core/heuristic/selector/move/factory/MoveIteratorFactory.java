...
public interface MoveIteratorFactory {
     ...
     * @return the approximate number of elements generated by {@link #createMoveIterator(ScoreDirector)}
     */
     ...
     * @return never null
     */
    Iterator<Move> createMoveIterator(ScoreDirector scoreDirector);
