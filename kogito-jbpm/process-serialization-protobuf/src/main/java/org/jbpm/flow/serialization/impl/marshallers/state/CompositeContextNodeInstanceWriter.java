...
public class CompositeContextNodeInstanceWriter implements NodeInstanceWriter {

    @Override
    public Integer order() {
        return NodeInstanceWriter.super.order() + 1;
    }

    @Override
    public boolean accept(NodeInstance value) {
        return value instanceof CompositeContextNodeInstance;
    }

    @Override
    public Builder<?> write(MarshallerWriterContext context, NodeInstance value) {
        CompositeContextNodeInstance nodeInstance = (CompositeContextNodeInstance) value;
