...
public final class Msg {
    ...
    public static final Message3 DTANALYSIS_2NDNFVIOLATION_WAS_DASH                  = new Message3( DMNMessageType.DECISION_TABLE_2NDNFVIOLATION, "Second Normal Form Violation: entry '%s' in rule %s column %s cover the entire domain. Consider rewrite this entry, simply as -.");
