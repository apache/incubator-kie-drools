...
class TestTaskServerHandler {
    ...
    TestTaskServerHandler(TaskService service, SystemEventListener systemEventListener) {
        this.handler = new TaskServerHandler(service, systemEventListener);
    }

    void messageReceived(BlockingQueue<byte []> producer, Object message) throws Exception {
