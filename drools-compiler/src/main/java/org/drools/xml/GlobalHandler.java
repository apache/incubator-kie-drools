 ...
 */
class GlobalHandler extends BaseAbstractHandler implements Handler
{
    GlobalHandler( PackageReader packageReader )
    {
    ...
    public Object end( String uri, String localName ) throws SAXException
    {
        ...
        packageDescr.addGlobal( config.getAttribute( "identifier" ), config.getText() );
        
        return new GlobalDummy();
    }

    public Class generateNodeFor()
    {
        return GlobalDummy.class;
    }
}