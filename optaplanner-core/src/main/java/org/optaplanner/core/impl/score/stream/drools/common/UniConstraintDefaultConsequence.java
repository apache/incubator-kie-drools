...
final class UniConstraintDefaultConsequence<A> extends AbstractUniConstraintConsequence<A> {

    private final UniLeftHandSide<A> leftHandSide;

    UniConstraintDefaultConsequence(UniLeftHandSide<A> leftHandSide) {
