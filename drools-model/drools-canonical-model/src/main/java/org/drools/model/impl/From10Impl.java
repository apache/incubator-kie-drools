...
public class From10Impl<A, B, C, D, E, F, G, H, I, J> implements From10<A, B, C, D, E, F, G, H, I, J>, ModelComponent {
    ...
    private final Function10<A, B, C, D, E, F, G, H, I, J, ?> provider;
    private final boolean reactive;

    public From10Impl(Variable<A> var1, Variable<B> var2, Variable<C> var3, Variable<D> var4, Variable<E> var5, Variable<F> var6, Variable<G> var7, Variable<H> var8, Variable<I> var9, Variable<J> var10, Function10<A, B, C, D, E, F, G, H, I, J, ?> provider) {
        this(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, provider, false);
    }

    public From10Impl(Variable<A> var1, Variable<B> var2, Variable<C> var3, Variable<D> var4, Variable<E> var5, Variable<F> var6, Variable<G> var7, Variable<H> var8, Variable<I> var9, Variable<J> var10, Function10<A, B, C, D, E, F, G, H, I, J, ?> provider, boolean reactive) {
        this.var1 = var1;
        this.var2 = var2;
        this.var3 = var3;
        this.var4 = var4;
    ...
    @Override
    public Function10<A, B, C, D, E, F, G, H, I, J, ?> getProvider() {
        return provider;
    }
    ...
    public boolean isEqualTo(ModelComponent o) {
        ...
        if (!(o instanceof From10Impl)) return false;

        From10Impl<?, ?, ?, ?, ?, ?, ?, ?, ?, ?> from = (From10Impl<?, ?, ?, ?, ?, ?, ?, ?, ?, ?>) o;
