...
public class FactInsertedEvent extends ExecutionEvent {
    private final String factClassName;
    private final String factIdentity;
    private final String factToString;
    private final String triggeringRule;
    public FactInsertedEvent(long sequenceNumber, String factClassName, String factIdentity,
                             String factToString, String triggeringRule) {
        super(sequenceNumber, EventType.FACT_INSERTED);
        this.factClassName = factClassName;
        this.factIdentity = factIdentity;
        this.factToString = factToString;
    ...
    public String toString() {
        return String.format("%s INSERT %s(%s)%s",
