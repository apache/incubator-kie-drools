...
public class FieldRange<T> {
    ...
    public static double getDoubleMaxValue(final ConditionParentType field) {
        try {
    ...
    public static double getDoubleMinValue(final ConditionParentType field) {
        try {
            if (field.getRange().isPresent()) {
    ...
    public static int getIntegerMaxValue(final ConditionParentType field) {
        try {
            if (field.getRange().isPresent()) {
    ...
    public static int getIntegerMinValue(final ConditionParentType field) {
        try {
            if (field.getRange().isPresent()) {
