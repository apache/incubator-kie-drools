...
public class ConsequenceBuilder {
    ...
    public static class _0 extends AbstractValidBuilder<_0> {
        ...
        public _0(String language, String ruleFile, String script) {
            super();
            this.usingDrools = true;
            this.language = language;
            this.block = new ScriptBlock(ruleFile, script);
        }
    ...
    public static class _1<A> extends AbstractValidBuilder<_1<A>> {
        ...
        public _1<A> executeScript(String language, String ruleFile, String script) {
            this.usingDrools = true;
            this.language = language;
            this.block = new ScriptBlock(ruleFile, script);
            return this;
    ...
    public static class _2<A, B> extends AbstractValidBuilder<_2<A,B>> {
        ...
        public _2<A, B> executeScript(String language, String ruleFile, String script) {
            this.usingDrools = true;
            this.language = language;
            this.block = new ScriptBlock(ruleFile, script);
            return this;
    ...
    public static class _3<A, B, C> extends AbstractValidBuilder<_3<A,B,C>> {
        ...
        public _3<A, B, C> executeScript(String language, String ruleFile, String script) {
            this.usingDrools = true;
            this.language = language;
            this.block = new ScriptBlock(ruleFile, script);
            return this;
    ...
    public static class _4<A, B, C, D> extends AbstractValidBuilder<_4<A,B,C,D>> {
        ...
        public _4<A, B, C, D> executeScript(String language, String ruleFile, String script) {
            this.usingDrools = true;
            this.language = language;
            this.block = new ScriptBlock(ruleFile, script);
            return this;
    ...
    public static class _5<A, B, C, D, E> extends AbstractValidBuilder<_5<A,B,C,D,E>> {
        ...
        public _5<A, B, C, D, E> executeScript(String language, String ruleFile, String script) {
            this.usingDrools = true;
            this.language = language;
            this.block = new ScriptBlock(ruleFile, script);
            return this;
    ...
    public static class _6<A, B, C, D, E, F> extends AbstractValidBuilder<_6<A,B,C,D,E,F>> {
        ...
        public _6<A, B, C, D, E, F> executeScript(String language, String ruleFile, String script) {
            this.usingDrools = true;
            this.language = language;
            this.block = new ScriptBlock(ruleFile, script);
            return this;
    ...
    public static class _N extends AbstractValidBuilder<_N> {
        ...
        public _N executeScript(String language, String ruleFile, String script) {
            this.usingDrools = true;
            this.language = language;
            this.block = new ScriptBlock(ruleFile, script);
            return this;
