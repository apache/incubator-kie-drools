...
include::ROOT:DMN/dmn-gs-new-project-creating-proc.adoc[leveloffset=+1]
...
include::ROOT:DMN/dmn-gs-creating-drd-proc.adoc[leveloffset=+2]
include::ROOT:DMN/dmn-gs-creating-custom-datatypes-proc.adoc[leveloffset=+2]
include::ROOT:DMN/dmn-gs-assigning-custom-datatypes-proc.adoc[leveloffset=+2]
include::ROOT:DMN/dmn-gs-defining-decision-logic-proc.adoc[leveloffset=+2]
...
include::ROOT:DMN/dmn-gs-testing-test-scenario-proc.adoc[leveloffset=+2]

include::ROOT:DMN/dmn-gs-evaluating-proc.adoc[leveloffset=+1]
