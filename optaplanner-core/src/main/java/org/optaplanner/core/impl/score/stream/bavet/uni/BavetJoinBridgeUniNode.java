...
public final class BavetJoinBridgeUniNode<A> extends BavetAbstractUniNode<A>
    ...
    private final BavetIndex<A, BavetJoinBridgeUniTuple<A>> index;

    public BavetJoinBridgeUniNode(BavetConstraintSession session, int nodeOrder, BavetAbstractUniNode<A> parentNode,
            Function<A, Object[]> mapping, BavetIndex<A, BavetJoinBridgeUniTuple<A>> index) {
    ...
    public BavetIndex<A, BavetJoinBridgeUniTuple<A>> getIndex() {
        return index;
    }
