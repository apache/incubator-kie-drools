...
public class TraitFieldsAndLegacyClassesTest extends CommonTraitTest {
    ...
    @ParameterizedTest
    void testTraitFieldUpdate0(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitFieldUpdate1(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitFieldUpdate2(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitFieldUpdate3(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @ParameterizedTest
    void testTraitFieldUpdate4(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitFieldUpdate5(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitFieldUpdate6(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitFieldUpdate7(VirtualPropertyMode mode) {
        String drl = "" +
                "package org.drools.factmodel.traits;\n" +
                "\n" +
                "import org.drools.core.factmodel.traits.Traitable;\n" +
...
//                     "   $c : Child( $gender := gender )\n"+
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitFieldUpdate8(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitFieldUpdate9(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitFieldUpdate10(VirtualPropertyMode mode) {
        String drl = "" +
                "package org.drools.factmodel.traits;\n" +
                "\n" +
                "import org.drools.core.factmodel.traits.Traitable;\n" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitTwoParentOneChild(VirtualPropertyMode mode) {
        String drl = "" +
                "package org.drools.factmodel.traits;\n" +
                "\n" +
                "import org.drools.core.factmodel.traits.Traitable;\n" +
    ...
    @Disabled
    @EnumSource(VirtualPropertyMode.class)
    void testTraitWithPositionArgs(VirtualPropertyMode mode) {
        String drl = "" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void singlePositionTraitTest(VirtualPropertyMode mode) {
        String drl = "" +
                "package org.drools.traits.test;\n" +
                "import org.drools.core.factmodel.traits.Traitable;\n" +
                "\n" +
