// $ANTLR 3.3 Nov 30, 2010 12:46:29 src/main/resources/org/drools/lang/dsl/DSLMap.g 2012-06-19 22:33:14
...
public class DSLMapParser extends Parser {
    ...
    public final DSLMapParser.entry_return entry() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: scope_section, value_section, key_section, meta_section
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final DSLMapParser.scope_section_return scope_section() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: value3, value4, value1, value2
            // token labels: 
    ...
    public final DSLMapParser.variable_definition_return variable_definition() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: q, q, name, name, name, q, name, name, name, q, name, q, name, q, q, name, q, q
            // token labels: q, name
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
