...
public class LegacyTraitTest extends CommonTraitTest {
    ...
    @ParameterizedTest
    void traitWithPojoInterface(VirtualPropertyMode mode) {
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void traitWithMixedInterfacesExtendingEachOther(VirtualPropertyMode mode) {
        String source = "package org.drools.compiler.test;" +
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testTraitWithNonAccessorMethodShadowing(VirtualPropertyMode mode) {
    ...
    @EnumSource(VirtualPropertyMode.class)
    @ParameterizedTest
    void testPojoExtendInterface(VirtualPropertyMode mode) {
        // DROOLS-697
