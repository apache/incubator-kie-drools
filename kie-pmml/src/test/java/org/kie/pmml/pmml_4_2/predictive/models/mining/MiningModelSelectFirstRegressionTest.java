...
public class MiningModelSelectFirstRegressionTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                { Optional.of(10.0), Optional.of(10.0), Optional.of(10.0), 670 },
                { Optional.of(-10.0), Optional.of(-25.0), Optional.of(10.0), 455 },
                { Optional.of(200.0), Optional.of(-1.0), Optional.of(2.0), -299 },
                { Optional.of(90.0), Optional.of(2.0), Optional.of(4.0), 17040 },
        });
    }

    public MiningModelSelectFirstRegressionTest(Optional<Double> input1, Optional<Double> input2,
