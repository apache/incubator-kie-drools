#set($str="")
        ...
        {artifactModelName}.${modelName}Model;
        {artifactModelName}.KiePMML${modelName}Model;
        {artifactModelName}.factories.KiePMML${modelName}ModelFactory;{artifactModelName}.KiePMML${modelName}Model.PMML_MODEL_TYPE;
...
public class $ {
    ...
    modelName
}ModelImplementationProvider implements ModelImplementationProvider<${modelName}Model,KiePMML${modelName}Model>{
